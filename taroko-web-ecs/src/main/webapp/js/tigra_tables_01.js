function tigra_tables ( 
	...
	col_config.odd_color = (str_odd_color ? str_odd_color : 'rgba(255,255,230,0.5)');
	col_config.even_color = (str_even_color ? str_even_color : 'rgba(255,255,179,0.5)');
	col_config.mover_color = (str_mover_color ? str_mover_color : 'rgba(255, 163, 102,0.5)');
	col_config.onclick_color = (str_onclick_color ? str_onclick_color : 'rgba(204,102,0,0.5)');
