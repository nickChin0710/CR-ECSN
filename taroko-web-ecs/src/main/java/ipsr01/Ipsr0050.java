...
public class Ipsr0050 extends BaseReport {

  InputStream inExcelFile = null;
  String mProgName = "ipsr0050";
  ...
  private boolean getWhereStr() throws Exception {
    ...
    if ("D".equals(exType)) {
    	queryTable = "ips_cgec_all";  //日檔
    	lsWhere += sqlCol("I2B001", "a.file_name", "like%");
    } else {
    	queryTable = "ips_i2b002_log";  //10日彙總檔
    }
  ...
  public void queryRead() throws Exception {
    ...
    wp.selectSQL = "a.txn_date, " + "c.id_no, " + "c.chi_name, " + "a.ips_card_no, " + "a.card_no, "
        + "a.txn_time, " + "to_char(to_date(a.txn_time,'hh24:mi:ss'),'HH24:mi:ss') as db_txn_time,"
        + "a.txn_amt, " + "a.crt_date, "+ "a.addr_cd ";
