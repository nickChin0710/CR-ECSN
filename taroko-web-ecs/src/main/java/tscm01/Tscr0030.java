...
* ---------  --------  ---------- ------------------------------------------ *
* 109-07-26  -------   jiangyigndong  creator  
* 111-04-20  V1.00.01  dingwenhao     TSC畫面整合                               *  
******************************************************************************/
package tscm01;
...
public class Tscr0030 extends BaseReport {

  InputStream inExcelFile = null;
  String mProgName = "tscr0030";
  ...
  private boolean getWhereStr() throws Exception {
    ...
    if (empty(exOppostDate1) && empty(exOppostDate2)) {
      ...
      // 入帳日期
      lsWhere += sqlStrend(exCrtDate1, exCrtDate2, "b.crt_date");  //bugfix
...
//        + "b.tran_amt_0h, " + "b.tran_amt_6h, " + "d.crt_date";
//    wp.daoTable = "tsc_card a " 
...
//    wp.whereOrder = "  ";
    ...
    wp.selectSQL = " a.oppost_date, b.crt_date, a.vd_card_no, d.id_no, d.chi_name, a.tsc_card_no, b.tran_amt_0h, b.tran_amt_6h, a.autoload_flag ";
    wp.daoTable = " tsc_vd_card a "
    		+ " left join tsc_dcbd_log b on a.tsc_card_no = b.tsc_card_no "
    		+ " left join dbc_card c on a.vd_card_no = c.card_no "
    		+ " left join dbc_idno d on c.id_p_seqno = d.id_p_seqno ";
    daoTable = wp.daoTable;
  ...
  void listWkdata() throws Exception {
    ...
    getWhereStr();
    String sqlSelect =
        "select sum(b.tran_amt_0h) as sum_tran_amt_0h , sum(b.tran_amt_6h) as sum_tran_amt_6h "
