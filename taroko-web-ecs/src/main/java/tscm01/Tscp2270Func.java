...
public class Tscp2270Func extends FuncAction {
  String lsBillDesc = "";
  ...
  public int dataProc() {
    ...
    strSql = "select * from tsc_dcpr_log" + " where 1=1 and rowid = ? and nvl(mod_seqno,0) = ? ";
...
//    Object[] param = new Object[] { varsStr("rowid"), varsStr("mod_seqno")};	
    ...
    strSql = " update tsc_dcpr_log set" + " apr_flag ='Y'"
  ...
  void insertBilSysexp() {
    ...
    strSql = "insert into tsc_dccg_all (" + " batch_no ," + " seq_no ," + " card_no ,"
    ...
    setString("file_name", "DCPR.01700000." + varsStr("notify_date") + "01");
