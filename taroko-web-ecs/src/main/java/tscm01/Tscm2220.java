...
* 112-04-17  V1.00.05  Alex       移除信用卡減值下拉選單                                                               *
******************************************************************************/
package tscm01;

import ofcapp.BaseAction;

public class Tscm2220 extends BaseAction {
  String rowid = "";
  ...
  public void saveFunc() throws Exception {
    tscm01.Tscm2220Func func = new tscm01.Tscm2220Func();
    func.setConn(wp);
  ...
  public void initButton() {
    if (eqIgno(wp.respHtml, "tscm2220_detl")) {
      btnModeAud("XX");
    }
