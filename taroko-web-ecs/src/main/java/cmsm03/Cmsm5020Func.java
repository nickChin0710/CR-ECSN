...
public class Cmsm5020Func extends FuncAction {
...
void initData() {
   ...
   idPSeqno = ""; majorIdPSeqno = ""; chiName ="";
}
...
void getInitData(String cardNo) throws Exception {
   initData();
   if(getDataSeqNo() == -1)
      return ;
   ...
   String sql2 = "select id_p_seqno , major_id_p_seqno , acct_type , acno_p_seqno , major_card_no , group_code , stmt_cycle , "
           + " uf_chi_name(card_no) as chi_name from crd_card where card_no = ? ";
...
//      return rc;
   ...
   sp.ppstr("file_name", wp.itemStr("C2.file_name"));
...
//   sp.ppstr("company_name", wp.itemStr("C2.company_name"));
   ...
   sp.ppstr("id_p_seqno", wp.itemStr("C2.id_p_seqno"));
   sp.ppstr("major_id_p_seqno", wp.itemStr("C2.major_id_p_seqno"));
   sp.ppstr("acct_type", wp.itemStr("C2.acct_type"));
   sp.ppstr("acno_p_seqno", wp.itemStr("C2.acno_p_seqno"));
   sp.ppstr("major_card_no", wp.itemStr("C2.major_card_no"));
   sp.ppstr("group_code", wp.itemStr("C2.group_code"));
   sp.ppstr("stmt_cycle", wp.itemStr("C2.stmt_cycle"));
   ...
   sp.ppstr("service_area", wp.itemStr("C2.service_area"));
   sp.ppstr("service_item", wp.itemStr("C2.service_item"));
   sp.ppstr("add_amt", wp.itemStr("C2.add_amt"));
   sp.ppstr("base_amt", wp.itemStr("C2.base_amt"));
   sp.ppstr("product_no", wp.itemStr("C2.product_no"));
   sp.ppstr("project_no", wp.itemStr("C2.project_no"));
   sp.ppstr("vd_flag", wp.itemStr("C2.vd_flag"));
   sp.ppstr("file_type", wp.itemStr("C2.file_type"));
   sp.ppstr("proc_flag", wp.itemStr("C2.proc_flag"));
//   sp.ppstr("service_days", wp.itemStr("C2.service_days"));
//   sp.ppstr("apply_days", wp.itemStr("C2.apply_days"));
//   sp.ppstr("item_no", "09");
