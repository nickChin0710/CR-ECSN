...
import mktp02.Mktp6270Func;
import ofcapp.AppMsg;
import java.util.Arrays;
import ofcapp.BaseProc;
import taroko.com.TarokoCommon;
// ************************************************************************
public class Mktp6270 extends BaseProc {
  private String PROGNAME = "雙幣卡外幣基金明細線上調整覆核處理程式108/10/14 V1.00.01";
  busi.ecs.CommFunction comm = new busi.ecs.CommFunction();
  busi.ecs.CommRoutine comr = null;
  mktp02.Mktp6270Func func = null;
  String rowid;
  String transSeqno;
  String fstAprFlag = "";
  String orgTabName = "cyc_dc_fund_dtl_t";
  ...
  public void queryRead() throws Exception {
    ...
    wp.selectSQL = " " + "hex(a.rowid) as rowid, " + "nvl(a.mod_seqno,0) as mod_seqno, "
        + "a.aud_type," + "'' as id_no," + "'' as chi_name," + "a.fund_code," + "a.fund_name,"
        + "a.curr_code," + "a.tran_code," + "a.beg_tran_amt," + "a.crt_user," + "a.crt_date,"
        + "a.tran_seqno," + "a.id_p_seqno," + "a.p_seqno";
  ...
  public void dataRead() throws Exception {
    ...
    wp.selectSQL = "hex(a.rowid) as rowid," + " nvl(a.mod_seqno,0) as mod_seqno, "
        ...
        + "a.crt_user," + "a.fund_code," + "a.fund_name," + "a.curr_code," + "a.acct_type,"
        + "a.tran_code," + "a.beg_tran_amt," + "a.effect_e_date," + "a.mod_reason," + "a.mod_desc,"
        + "a.mod_memo," + "a.id_p_seqno";

    wp.daoTable = controlTabName + " a ";
    wp.whereStr = "where 1=1 ";
    if (qFrom == 0) {
      wp.whereStr = wp.whereStr + sqlCol(transSeqno, "a.tran_seqno");
    } else if (qFrom == 1) {
    ...
    checkButtonOff();
    transSeqno = wp.colStr("tran_seqno");
    listWkdataAft();
...
//          + " and    b.p_seqno = '" + wp.colStr("p_seqno") + "' ";
  ...
  public void dataReadR3R() throws Exception {
    ...
    controlTabName = "CYC_DC_FUND_DTL";
    wp.selectSQL = "hex(a.rowid) as rowid," + " nvl(a.mod_seqno,0) as mod_seqno, "
        + "a.tran_seqno as tran_seqno," + "a.crt_user as bef_crt_user,"
        + "a.fund_code as bef_fund_code," + "a.fund_name as bef_fund_name,"
        + "a.curr_code as bef_curr_code," + "a.acct_type as bef_acct_type,"
        + "a.tran_code as bef_tran_code," + "a.beg_tran_amt as bef_beg_tran_amt,"
        + "a.effect_e_date as bef_effect_e_date," + "a.mod_reason as bef_mod_reason,"
        + "a.mod_desc as bef_mod_desc," + "a.mod_memo as bef_mod_memo,"
        + "a.id_p_seqno as bef_id_p_seqno";

    wp.daoTable = controlTabName + " a ";
    wp.whereStr = "where 1=1 " + sqlCol(transSeqno, "a.tran_seqno");
  ...
  void listWkdata() throws Exception {
    ...
    commCurrCode("comm_curr_code");
    commCurrCode("comm_bef_curr_code", 1);
  ...
  public void dataProcess() throws Exception {
    ...
    int ilErr = 0;
    int ilAuth = 0;
    mktp02.Mktp6270Func func = new mktp02.Mktp6270Func(wp);
  ...
  public void dddwSelect() {
    String lsSql = "";
    try {
      if ((wp.respHtml.equals("mktp6270"))) {
        wp.initOption = "--";
        wp.optionKey = "";
  ...
  // ************************************************************************
  public void commCurrCode(String columnData1, int befType) throws Exception {
    String columnData = "";
    String sql1 = "";
    String befStr = "";
    if (befType == 1)
    ...
    for (int ii = 0; ii < wp.selectCnt; ii++) {
      ...
      sql1 = "select " + " curr_chi_name as column_curr_chi_name " + " from ptr_currcode "
          + " where 1 = 1 " 
//    	  + " and   curr_code = '" + wp.colStr(ii, befStr + "curr_code") + "'";
      	  + " and curr_code = :curr_code ";
      	  setString("curr_code",wp.colStr(ii, befStr + "curr_code"));
...
public String procDynamicDddwCrtuser1(String string)  throws Exception
{
  ...
  lsSql = " select "
         ...
         + " from sec_user a,cyc_dc_fund_dtl_t b "
