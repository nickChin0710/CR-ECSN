...
* 109-09-03  V1.00.01  Andy       update Mantis4007     
...
public class Actm0110Func extends FuncEdit {
	String pPSeqno = "";
	String mAccttype="";
    String mAcctkey="";
    String mCardno="";
	...
	public Actm0110Func(TarokoCommon wr) {
		wp = wr;
...
//			return;
	...
	public int dbInsert() {
		...
		sp.ppstr("trans_acct_type", wp.itemStr2("trans_acct_type"));
