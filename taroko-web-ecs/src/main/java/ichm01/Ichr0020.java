...
public class Ichr0020 extends BaseAction implements InfacePdf {
  ...
  public void queryFunc() throws Exception {
    ...
    String lsWhere =
        " where 1=1 and A.op_mark='1' " + sqlCol(wp.itemStr2("ex_crt_date1"), "A.crt_date", ">=")
  ...
  public void queryRead() throws Exception {
    ...
    wp.selectSQL = "" + " A.crt_date ," + " A.txn_date ," + " A.txn_time ," + " A.txn_amt ,"
        + " A.agency_cd ," + " A.store_cd ," + " A.ich_card_no ," + " A.merchine_type ,"
        + " A.merchine_no ," + " A.op_mark ," + " B.card_no ";
  ...
  public void pdfPrint() throws Exception {
    ...
    wp.fileMode = "Y";
    pdf.excelTemplate = "ichr0020.xlsx";
    pdf.pageCount = 30;
    pdf.sheetNo = 0;
