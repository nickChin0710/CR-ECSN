...
public class Ichm0030 extends BaseAction {
  ...
  public void dataRead() throws Exception {
    ...
    wp.selectSQL = "" + " parm_type ," + " seq_no ," + " parm_desc ," + " amt01_txt ," + " amt01 ,"
        + " amt02_txt ," + " amt02 ," + " cnt01 ," + " cnt01_txt ," + " cnt02 ," + " cnt02_txt ,"
        + " send_date ," + " crt_date ," + " crt_user ," + " apr_date ," + " apr_user ,"
        + " mod_user ," + " to_char(mod_time,'yyyymmdd') as mod_date ," + " mod_pgm ,"
        + " mod_seqno ," + " hex(rowid) as rowid ";

    wp.daoTable = "ich_00_parm";
    wp.whereStr = " where 1=1 " + " and parm_type = 'ICHM0030' " + " and seq_no = 0 ";
  ...
  public void saveFunc() throws Exception {
    if (checkApproveZz() == false)
      return;
    ichm01.Ichm0030Func func = new ichm01.Ichm0030Func();
    func.setConn(wp);
