...
public class Dbam0060Func extends FuncEdit {
  String kkRowid = "";
  String acctType = "", code = "", groupCode = "";

  public Dbam0060Func(TarokoCommon wr) {
    wp = wr;
  ...
  public void dataCheck() {
    ...
    if (isAdd()) {
      ...
      Object[] param = new Object[] {acctType, code, groupCode};
      ...
      if (isUpdate()) {
        ...
        Object[] param = new Object[] {acctType, code, groupCode, kkRowid};
        sqlSelect(lsSql, param);
        if (colNum("tot_cnt") > 0) {
          errmsg("團體代號已存在，無法修改");
          return;
