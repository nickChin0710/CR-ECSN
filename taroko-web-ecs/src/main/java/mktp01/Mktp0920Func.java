...
* ---------  --------  -----------    ------------------------------------ *
* 112/05/09  V1.00.01   machao      Initial                                *
***************************************************************************/
package mktp01;

import taroko.com.TarokoCommon;

public class Mktp0920Func extends busi.FuncProc{
	private final String PROGNAME = "稅務活動回饋參數覆核112/04/21 V1.00.01";
	  String approveTabName = "mkt_goldbill_parm";
	  String controlTabName = "mkt_goldbill_parm_t";

	  public Mktp0920Func(TarokoCommon wr) {
	    wp = wr;
	  ...
	  public int dbInsertA4() {
	    ...
	    if (rc != 1)
	      return rc;
	    strSql = " insert into  " + approveTabName + " (" + " active_code, " + " active_name, " + " stop_flag, " + " stop_date, " 
	    	+ " active_type, " + " purchase_date_s, " + " purchase_date_e, "  + " active_date_s, "
	    ...
	    Object[] param = new Object[] {colStr("active_code"), colStr("active_name"),colStr("stop_flag"), colStr("stop_date"), colStr("active_type"),
	    		 colStr("purchase_date_s"), colStr("purchase_date_e"),colStr("active_date_s"), colStr("active_date_e"),
	  ...
	  public int dbSelectS4() {
	    ...
	    strSql = " select " + " active_code, " + " active_name, "+ " stop_flag, " + " stop_date, " + " active_type, "
		    	+ " purchase_date_s, " + " purchase_date_e, " + " active_date_s, " + " active_date_e, " + " feedback_cycle, " + " feedback_dd, "
		        + " apr_date, " + " apr_user, "
		        + " crt_date, " + " crt_user, "
	  ...
	  public int dbUpdateU4() {
	    ...
	    if (rc != 1)
	      return rc;
	    String aprFlag = "Y";
	    strSql = "update " + approveTabName + " set " + "active_name = ?, " + " stop_flag = ?, " + " stop_date = ?, " + "active_type = ?, "
	    ...
	    Object[] param = new Object[] {colStr("active_name"), colStr("stop_flag"), colStr("stop_date"),colStr("active_type"),
	    	colStr("purchase_date_s"), colStr("purchase_date_e"), colStr("active_date_s"), colStr("active_date_e"),
