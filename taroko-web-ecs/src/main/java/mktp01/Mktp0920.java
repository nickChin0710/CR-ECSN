...
* ---------  --------  -----------    ------------------------------------ *
* 112/05/11  V1.00.01   machao      Initial ，新增權限覆核                   *
***************************************************************************/
package mktp01;
...
public class Mktp0920 extends BaseProc{
	private final String PROGNAME = "稅務活動回饋參數覆核112/04/21 V1.00.01";
	String orgTabName = "MKT_GOLDBILL_PARM_T";
...
//	      dataReadActCode();
	...
	public void dataRead() throws Exception {
		...
		if (qFrom == 0)
		    ...
		    wp.selectSQL = "hex(a.rowid) as rowid," + " nvl(a.mod_seqno,0) as mod_seqno, " + "a.aud_type,"
		        ...
		        + "a.active_name,"  + "a.stop_flag," + "a.stop_date," + "a.active_type,"
		        + "a.purchase_date_s," + "a.purchase_date_e," + "a.active_date_s,"
	 ...
	 public void dataReadR3R() throws Exception
	 {
	  ...
	  controlTabName = "MKT_GOLDBILL_PARM";
	  ...
	  commfuncAudType("aud_type");
	  commfuncActType("bef_active_type");
	...
	public void dataProcess() throws Exception {
		// TODO Auto-generated method stub
		    ...
		    int ilAuth = 0;
		    String lsUser="";
		    mktp01.Mktp0920Func func = new mktp01.Mktp0920Func(wp);
	 ...
	 // ************************************************************************
	  ...
	  public void dddwSelect() {
	    String lsSql = "";
	    try {
	      if ((wp.respHtml.equals("mktp0920"))) {
	        wp.initOption = "--";
	        wp.optionKey = "";
	        if (wp.colStr("ex_active_code").length() > 0) {
	          wp.optionKey = wp.colStr("ex_active_code");
	        }
	        this.dddwList("dddw_active_code", "mkt_goldbill_parm_t", "trim(active_code)",
