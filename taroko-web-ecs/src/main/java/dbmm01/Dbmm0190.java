...
*  110-10-22  V1.00.05  Yangbo       joint sql replace to parameters way   *
* 111-12-28  V1.00.07  Zuwei Su       無法顯示輸入參數最新筆數             *
* 113-04-03  V1.00.08   yang han       增加 [一般消費群組]選項
* 112-05-08  V1.00.09  Zuwei Su       特店群組來源條件修改，一般消費群組data_type寫入'P'              *
*****************************************************************************/
package dbmm01;

import dbmm01.Dbmm0190Func;
...
// ************************************************************************
public class Dbmm0190 extends BaseEdit
{
  private final String PROGNAME = "Visa金融卡紅利加贈參數維護-新發卡處理程式108/12/02 V1.00.01";
  busi.ecs.CommFunction comm = new busi.ecs.CommFunction();
  busi.ecs.CommRoutine comr = null;
  dbmm01.Dbmm0190Func func = null;
  String rowid;
  String activeCode;
  String fstAprFlag = "";
  String orgTabName = "dbm_bpis";
  ...
  public void dataRead() throws Exception {
    ...
    wp.selectSQL = "hex(a.rowid) as rowid," + " nvl(a.mod_seqno,0) as mod_seqno, "
        ...
        + "a.mcc_code_sel," + "a.pos_entry_sel," + "a.bp_amt," + "a.bp_pnt," + "a.add_times,"
        + "a.add_point," + "a.crt_user," + "a.crt_date," + "a.apr_user," + "a.apr_date";
  ...
  public void dataReadR3R() throws Exception {
    ...
    wp.selectSQL = "hex(a.rowid) as rowid," + " nvl(a.mod_seqno,0) as mod_seqno, "
        ...
        + "a.new_card_cond as new_card_cond," + "a.active_s_date as active_s_date,"
        + "a.active_e_date as active_e_date," + "a.re_months as re_months,"
        + "a.acct_type_sel as acct_type_sel," + "a.group_code_sel as group_code_sel,"
        + "a.merchant_sel as merchant_sel," + "a.mcht_group_sel as mcht_group_sel," + "a.platform_kind_sel as platform_kind_sel,"
        + "a.mcc_code_sel as mcc_code_sel," + "a.pos_entry_sel as pos_entry_sel,"
        + "a.bp_amt as bp_amt," + "a.bp_pnt as bp_pnt," + "a.add_times as add_times,"
        + "a.add_point as add_point," + "a.crt_user as crt_user," + "a.crt_date as crt_date,"
  ...
  public void dataReadR2() throws Exception {
    ...
    wp.daoTable = bnTable;
    wp.whereStr = "where 1=1" + " and table_name  =  'DBM_BPIS' ";
...
//    whereCnt += " and  data_key = '" + wp.itemStr("active_code") + "'";
  ...
  public void updateFuncU2() throws Exception {
    dbmm01.Dbmm0190Func func = new dbmm01.Dbmm0190Func(wp);
    int llok = 0, llerr = 0;
...
//    whereCnt += " and  data_key = '" + wp.itemStr("active_code") + "'";
  ...
  public void updateFuncU3() throws Exception {
    ...
    alertMsg("資料存檔處理完成  成功(" + lsOk + "), 失敗(" + llerr + ")");
  ...
  public void dddwSelect() {
    String ls_sql = "";
    try {
      if ((wp.respHtml.equals("dbmm0190_nadd")) || (wp.respHtml.equals("dbmm0190_detl"))) {
        wp.optionKey = "";
        wp.initOption = "";
...
//              + " and   mcht_group_id = '" + wp.colStr(ii, "data_code") + "'";
  ...
  void fileDataImp2() throws Exception {
    ...
    while (true) {
      ...
      if (sysUploadAlias.equals("mcht"))
        if (checkUploadfileMcht(tmpStr) != 0)
          continue;
    ...
    alertMsg("資料匯入處理筆數 : " + llCnt + ", 成功(" + lsOk + "), 重複(" + llErr + "), 失敗("
        + (llCnt - lsOk - llErr) + ")");
...
{
 wp.colSet("acct_type_sel_cnt" , listDbmBnData("dbm_bn_data_t","DBM_BPIS",wp.colStr("active_code"),"3"));
 wp.colSet("group_code_sel_cnt" , listDbmBnData("dbm_bn_data_t","DBM_BPIS",wp.colStr("active_code"),"2"));
 wp.colSet("merchant_sel_cnt" , listDbmBnData("dbm_bn_data_t","DBM_BPIS",wp.colStr("active_code"),"1"));
 wp.colSet("mcht_group_sel_cnt" , listDbmBnData("dbm_bn_data_t","DBM_BPIS",wp.colStr("active_code"),"6"));
 wp.colSet("platform_kind_sel_cnt" , listDbmBnData("dbm_bn_data_t","DBM_BPIS",wp.colStr("active_code"),"P"));
 wp.colSet("mcc_code_sel_cnt" , listDbmBnData("dbm_bn_data_t","DBM_BPIS",wp.colStr("active_code"),"5"));
 wp.colSet("pos_entry_sel_cnt" , listDbmBnData("dbm_bn_data_t","DBM_BPIS",wp.colStr("active_code"),"4"));
}
//************************************************************************
void listWkdata() throws Exception
{
 wp.colSet("acct_type_sel_cnt" , listDbmBnData("dbm_bn_data","DBM_BPIS",wp.colStr("active_code"),"3"));
 wp.colSet("group_code_sel_cnt" , listDbmBnData("dbm_bn_data","DBM_BPIS",wp.colStr("active_code"),"2"));
 wp.colSet("merchant_sel_cnt" , listDbmBnData("dbm_bn_data","DBM_BPIS",wp.colStr("active_code"),"1"));
 wp.colSet("mcht_group_sel_cnt" , listDbmBnData("dbm_bn_data","DBM_BPIS",wp.colStr("active_code"),"6"));
 wp.colSet("platform_kind_sel_cnt" , listDbmBnData("dbm_bn_data","DBM_BPIS",wp.colStr("active_code"),"P"));
 wp.colSet("mcc_code_sel_cnt" , listDbmBnData("dbm_bn_data","DBM_BPIS",wp.colStr("active_code"),"5"));
 wp.colSet("pos_entry_sel_cnt" , listDbmBnData("dbm_bn_data","DBM_BPIS",wp.colStr("active_code"),"4"));
}
  // ************************************************************************
