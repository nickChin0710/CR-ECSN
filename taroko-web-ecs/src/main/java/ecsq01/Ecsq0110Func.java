...
// ************************************************************************
public class Ecsq0110Func extends FuncEdit {
  private String PROGNAME = "系統刪除資料庫表格紀錄檔查詢處理程式109/12/28 V1.00.03";
  String controlTabName = "ecs_deltab_log";

  public Ecsq0110Func(TarokoCommon wr) {
    wp = wr;
