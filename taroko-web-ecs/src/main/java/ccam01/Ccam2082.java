...
public class Ccam2082 extends BaseAction {
...
//		getWhere();
	...
	void dataReadAfter() {
		wp.sqlCmd = "select id_no ," + " chi_name, birthday , cellar_phone , "
		...
		if (sqlRowNum > 0) {
			...
			sql2Col("A.cellar_phone","cellar_phone");
		}
		...
		String sql1 = " select " + " block_reason1||','||" + " block_reason2||','||" + " block_reason3||','||"
				...
				+ " spec_status as acct_spec_status , card_acct_idx , "
	...
	public void saveFunc() throws Exception {
		...
		ccam01.Ccam2082Func func = new ccam01.Ccam2082Func();
		func.setConn(wp);
