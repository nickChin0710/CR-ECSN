...
public class CcaSpecialVisa extends FuncBase {
  ...
  public int dbUpdate() {
    strSql = "update cca_special_visa set" + " from_type ='1'" + ", spec_status =:spec_status"
        ...
        + ", chg_user =:chg_user" + "," + commSqlStr.setModxxx(modUser, modPgm) + " where card_no =:kk1";
