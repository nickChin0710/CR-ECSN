...
public class Ccam2013 extends ofcapp.BaseAction {

  String isOppType = "3"; // 一般停用
  ...
  void queryAfter() throws Exception {
    String sql1 = " select " + " oppo_user , " + " logic_del_date , " + " logic_del_time , "
        + " logic_del_user , " + " oppo_time " + " from cca_opposition " + " where card_no = ? ";
	...
	for (int ii = 0; ii < wp.selectCnt; ii++) {
		...
		wp.colSet(ii, "A-tt_oppost_reason", oppostReason);
	}
  }
