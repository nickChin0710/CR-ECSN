 ...
 * 2019-0610:  JH    p_seqno >>acno_p_seqno
   2019-0308:  JH    手動outgoing查詢
 * 2018-0712  Alex  fix oppo_user
 *  
 * */
import taroko.com.TarokoCommon;

public class Ccam2012 extends ofcapp.BaseAction {
  ...
  void queryAfter() throws Exception {
	...
	for (int ii = 0; ii < wp.selectCnt; ii++) {
		...
		wp.colSet(ii, "tt_oppo_reason", oppostReason);
	}
  }
  ...
  public void dataRead() throws Exception {
    ...
    ibDebit = this.eqAny(debitFlag,"Y");
