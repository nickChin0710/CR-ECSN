 ...
 * 110-11-15 V1.00.03   Justin        display opp_status S1                                                                              *  
 **/ 
 ...
 * 2019-0610:  JH    p_seqno >>acno_xxx
   190308:     JH    outgoing_query
 * 2018-0712  Alex  fix oppo_user
 * 
 * */
import taroko.com.TarokoCommon;

public class Ccam2014 extends ofcapp.BaseAction {
  ...
  public void dddwSelect() {
    try {
      ...
      this.dddwList("dddw_oppo_reason", "cca_opp_type_reason", "opp_status", "opp_remark",
          " where onus_opp_type='4' " 
//          + " and opp_status != 'S1' "  // Justin 2021/11/15 display opp_status S1
      );
  ...
  public void queryRead() throws Exception {
    ...
    if (wp.selectCnt == 1) {
      ...
      currentCode = wp.colStr("current_code");
...
//    wp.colSet("oppo_reason", sqlStr("oppo_status"));
  ...
  public void saveFunc() throws Exception {
    if ("Y".equals(wp.itemStr("damage_flag"))) {
      wp.itemSet("renew_flag", "Y");
    }
