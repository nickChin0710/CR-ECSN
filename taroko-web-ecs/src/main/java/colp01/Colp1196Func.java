...
public class Colp1196Func extends FuncProc {
	String liadDocNo;
	String liadDocSeqno;

	public Colp1196Func(TarokoCommon wr) {
		wp = wr;
	...
	public void dataCheck() {
		...
		if (isOtherModify("col_liad_renew_court", sqlWhere, param)) {
			return;
		}
	...
	int deleteFunc() {
		...
		strSql = "delete col_liad_renew_court " + sqlWhere;
		Object[] param = new Object[] { liadDocNo, liadDocSeqno, varModseqno() };
	...
	public int updateColLiadRenewCaseDate() {
		strSql = "update col_liad_renew set case_date = "
				+ " (select nvl(max(case_date),'') as case_date from col_liad_renew_court "
				+ " where liad_doc_no = col_liad_renew.liad_doc_no and apr_flag = 'Y'), "
