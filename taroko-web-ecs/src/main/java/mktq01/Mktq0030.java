...
import mktq01.Mktq0030Func;
import ofcapp.AppMsg;
import java.util.Arrays;
import ofcapp.BaseEdit;
import taroko.com.TarokoCommon;
// ************************************************************************
public class Mktq0030 extends BaseEdit {
  private String PROGNAME = "紅利來源新增查詢處理程式108/08/18 V1.00.01";
  busi.ecs.CommFunction comm = new busi.ecs.CommFunction();
  busi.ecs.CommRoutine comr = null;
  mktq01.Mktq0030Func func = null;
  String rowid;// kk2;
  String orgTabName = "mkt_bonus_stat1";
  ...
  public void queryRead() throws Exception {
    ...
    wp.selectSQL = " "
            ...
            + "sum(MONTH_PNT) as month_pnt,"
            + "sum(YEAR_CNT) as year_cnt,"
            + "sum(YEAR_PNT) as year_pnt,"
            + "sum(last_month_CNT) as last_month_cnt,"
            + "sum(last_month_pNT) as last_month_pnt";
  ...
  public void querySelect() throws Exception {
    ...
    wp.colSet("stat_month", itemKk("data_k2"));
    qFrom = 1;
    dataRead1();
  }

  // ************************************************************************
  public void querySelect_1() throws Exception {
    controlTabName = orgTabName;
  ...
  public void dataRead() throws Exception {
    ...
    if (qFrom == 0) {
      ...
      wp.whereStr = wp.whereStr + sqlCol(wp.colStr("bb_stat_month"), "a.stat_month")
          + sqlCol(wp.itemStr("ex_acct_type"), "a.acct_type", "like%")
          + sqlStrend(wp.itemStr("ex_stat_month_s"), wp.itemStr("ex_stat_month_e"), "a.stat_month")
          + " group by stat_month,sign_flag,tran_code" + " order by TRAN_CODE,sign_flag";
    } else {
  ...
  public void dataRead1() throws Exception {
    ...
    wp.whereStr = wp.whereStr + sqlCol(itemKk("data_k2"), "a.stat_month")
  ...
  public void saveFunc() throws Exception {
    mktq01.Mktq0030Func func = new mktq01.Mktq0030Func(wp);
  ...
  public void dddwSelect() {
    String lsSql = "";
    try {
//      if ((wp.respHtml.equals("mktq0030"))) {
//        wp.initOption = "--";
//        wp.optionKey = "";
...
//    }
  ...
  // ************************************************************************
  public void commSignFlag(String cde1) throws Exception {
    String[] cde = {"1", "2"};
    String[] txt = {"點數增加", "點數減少"};
    String columnData = "";
    for (int ii = 0; ii < wp.selectCnt; ii++) {
      for (int inti = 0; inti < cde.length; inti++) {
        String txt1 = cde1.substring(5, cde1.length());
