...
// ************************************************************************
public class Mktq0032Func extends FuncEdit {
  private String PROGNAME = "紅利積點區間查詢處理程式108/01/29 V1.00.01";
  String acctType, statMonth;
  String controlTabName = "mkt_bonus_stat3";

  public Mktq0032Func(TarokoCommon wr) {
    wp = wr;
