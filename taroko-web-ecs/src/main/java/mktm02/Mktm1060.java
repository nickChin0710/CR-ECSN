...
import mktm02.Mktm1060Func;
import ofcapp.AppMsg;
import java.util.Arrays;
import ofcapp.BaseEdit;
import taroko.com.TarokoCommon;
// ************************************************************************
public class Mktm1060 extends BaseEdit {
  private String PROGNAME = "高鐵生檔不送簡訊清單處理程式108/10/31 V1.00.01";
  busi.ecs.CommFunction comm = new busi.ecs.CommFunction();
  busi.ecs.CommRoutine comr = null;
  mktm02.Mktm1060Func func = null;
  ...
  public void queryFunc() throws Exception {
    wp.whereStr = "WHERE 1=1 " + sqlCol(wp.itemStr("ex_data_type"), "a.data_type", "like%")
        + sqlCol(wp.itemStr("ex_data_code"), "a.data_code", "like%")
        + " and table_name  =  'MKT_THSR_UPTXN' " + " and data_key  =  'THSR_LIST' ";
  ...
  public void queryRead() throws Exception {
    ...
    wp.selectSQL = " " + "hex(a.rowid) as rowid, " + "nvl(a.mod_seqno,0) as mod_seqno, "
        + "a.data_type," + "a.data_code," + "a.crt_user," + "a.crt_date";
  ...
  public void dataRead() throws Exception {
    ...
    wp.selectSQL = "hex(a.rowid) as rowid," + " nvl(a.mod_seqno,0) as mod_seqno, "
        + "a.data_type as data_type," + "a.data_code as data_code," + "a.crt_user," + "a.crt_date";
    ...
    commDataType1("comm_data_type");
    checkButtonOff();
  }

  // ************************************************************************
  public void saveFunc() throws Exception {
    mktm02.Mktm1060Func func = new mktm02.Mktm1060Func(wp);
  ...
  // ************************************************************************
  public void commDataType1(String cde1) throws Exception {
    String[] cde = {"1", "2"};
    String[] txt = {"身分證號", "手機號碼"};
    String columnData = "";
