...
public class Mktm4080 extends BaseAction {
  ...
  public void dddwSelect() {
    try {
      if (eqIgno(wp.respHtml, "mktm4080")) {
  ...
  public void queryFunc() throws Exception {
	    ...
	    String exAprFlag = wp.itemStr("ex_apr_flag");
	    if ("N".equals(exAprFlag)) {
	    	wp.whereStr += "and A.apr_date = '' ";
	    }

	    //已出年費不可再更改
	    wp.whereStr += "and A.maintain_code != 'Y' ";
  ...
  public void procFunc() throws Exception {
    ...
    mktm02.Mktm4080Func func = new mktm02.Mktm4080Func();
    func.setConn(wp);
    ...
    */
    ...
    alertMsg("處理完成: 成功筆數=" + ilOk + "; 失敗筆數=" + ilErr);
  ...
  void pdfPrint() throws Exception {
	    ...
	    wp.fileMode = "Y";
	    pdf.excelTemplate = "mktm4080.xlsx";
	    pdf.sheetNo = 0;
	    pdf.pageCount = 20;
