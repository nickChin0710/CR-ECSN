...
// ************************************************************************
public class Mktm6120 extends BaseEdit {

  private ArrayList<Object> params = new ArrayList<Object>();
  private String PROGNAME = "年費優惠免收參數設定作業處理程式108/08/20 V1.00.01";
  busi.ecs.CommFunction comm = new busi.ecs.CommFunction();
  busi.ecs.CommRoutine comr = null;
  mktm02.Mktm6120Func func = null;
  String rowid, dataKK2;
  String orgTabName = "cyc_offer_afee_parm";
  ...
  public void queryRead() throws Exception {
    ...
    wp.selectSQL =
        " " + "hex(a.rowid) as rowid, " + "nvl(a.mod_seqno,0) as mod_seqno, " + "a.group_code,"
            + "a.card_type," + "a.last_ttl_amt," + "a.first_fee_rc," + "a.other_fee_rc,"
            + "a.first_fee_nrc," + "a.other_fee_nrc," + "a.apr_user," + "a.apr_date";

    wp.daoTable = controlTabName + " a ";
    wp.whereOrder = " " + " order by a.group_code,a.card_type";
  ...
  public void dataRead() throws Exception {
    ...
    wp.selectSQL = "hex(a.rowid) as rowid," + " nvl(a.mod_seqno,0) as mod_seqno, "
        + "a.group_code as group_code," + "a.card_type as card_type," + "b.first_fee as first_fee,"
        + "b.other_fee as other_fee," + "b.sup_rate as sup_rate,"
        + "b.sup_end_month as sup_end_month," + "b.sup_end_rate as sup_end_rate,"
        + "a.last_ttl_amt," + "a.first_fee_rc," + "a.other_fee_rc," + "a.sup_rate_rc,"
        + "a.sup_end_month_rc," + "a.sup_end_rate_rc," + "a.last_ttl_amt," + "a.first_fee_nrc,"
        + "a.other_fee_nrc," + "a.sup_rate_nrc," + "a.sup_end_month_nrc," + "a.sup_end_rate_nrc,"
        + "a.crt_user," + "a.crt_date," + "a.apr_user," + "a.apr_date";

    wp.daoTable = controlTabName + " a " + "LEFT OUTER JOIN ptr_group_card b "
        + "ON a.group_code = b.group_code " + " and a.card_type=b.card_type  ";
  ...
  public void saveFunc() throws Exception {
    ...
    mktm02.Mktm6120Func func = new mktm02.Mktm6120Func(wp);
  ...
  public void dddwSelect() {
    String ls_sql = "";
    try {
      if ((wp.respHtml.equals("mktm6120_detl"))) {
        wp.initOption = "";
        wp.optionKey = "";
      ...
      if ((wp.respHtml.equals("mktm6120"))) {
        wp.initOption = "--";
        wp.optionKey = "";
