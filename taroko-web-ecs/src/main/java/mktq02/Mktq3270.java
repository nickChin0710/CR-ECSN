...
import mktq02.Mktq3270Func;
import ofcapp.AppMsg;
import java.util.Arrays;
import ofcapp.BaseEdit;
import taroko.com.TarokoCommon;
// ************************************************************************
public class Mktq3270 extends BaseEdit {
  private final String PROGNAME = "高鐵車廂請款明細檔維護處理程式";
...
//            + " and error_code  >=  '90' "
  ...
  public void queryRead() throws Exception {
    ...
    wp.selectSQL = " " + "hex(a.rowid) as rowid, " + "nvl(a.mod_seqno,0) as mod_seqno, "
        + "a.serial_no," + "a.trans_date," + "a.trans_type," 
//    		+ "a.auth_flag," 
        + "a.pay_cardid,"
        + "a.authentication_code," 
//        + "a.error_code," + "a.error_desc," 
        +"a.BP_CHECK_DATE,"
        + "a.proc_date,"
//        + "a.crt_date," 
        + "a.apr_date";
...
//        + wp.colStr("card_mode") + "'";
  ...
  public void saveFunc() throws Exception {
    mktq02.Mktq3270Func func = new mktq02.Mktq3270Func(wp);
