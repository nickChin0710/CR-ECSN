...
// ************************************************************************
public class Mktm0930Func extends FuncEdit {
  private final String PROGNAME = "數位帳戶VD卡活動回饋參數維護112/07/03 V1.00.01";
  String mchtGroupId;
  String orgControlTabName = "MKT_DIGACCTVD_PARM";
  String controlTabName = "MKT_DIGACCTVD_PARM_T";

  public Mktm0930Func(TarokoCommon wr) {
    wp = wr;
  ...
  public int dataSelect() {
    ...
    strSql = " select " + " active_code, " + "active_name," 
    + "active_date_s," + "active_date_e,"
  ...
  public void dataCheck() {
    ...
    if (this.ibUpdate) {
      strSql = "select count(*) as qua from MKT_DIGACCTVD_PARM_T where active_code = ?";
