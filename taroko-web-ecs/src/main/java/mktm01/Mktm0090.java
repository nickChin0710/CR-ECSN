...
// ************************************************************************
 ...
 public void queryRead() throws Exception
 {
  ...
  wp.daoTable = controlTabName + " a "
              ;
  wp.whereOrder = " "
                + " order by a.active_code desc,a.bonus_type,a.acct_type "
                ;
...
// ************************************************************************
 ...
 {
  wp.colSet("merchant_sel_cnt" , listCycBnData("cyc_bn_data","CYC_BPID2",wp.colStr("active_code"),"1"));
  wp.colSet("mcht_group_sel_cnt" , listCycBnData("cyc_bn_data","CYC_BPID2",wp.colStr("active_code"),"4"));
  wp.colSet("platform_kind_sel_cnt" , listCycBnData("cyc_bn_data","CYC_BPID2",wp.colStr("active_code"),"P"));
  wp.colSet("group_card_sel_cnt" , listCycBnData("cyc_bn_data","CYC_BPID2",wp.colStr("active_code"),"2"));
  wp.colSet("group_merchant_sel_cnt" , listCycBnData("cyc_bn_data","CYC_BPID2",wp.colStr("active_code"),"3"));
 }
// ************************************************************************
...
// ************************************************************************
 ...
 {
   Mktm0090Func func =new Mktm0090Func(wp);
   int llOk = 0, llErr = 0;
...
// ************************************************************************
 public void dataReadR2(int fromType) throws Exception
 {
   ...
   if (wp.respHtml.equals("mktm0090_mcgp2")) {
       commDataCode342("comm_data_code");
   }
  }
// ************************************************************************
...
// ************************************************************************
 ...
 public void dddwSelect()
 {
  String ls_sql ="";
  try {
       if ((wp.respHtml.equals("mktm0090_nadd"))||
           (wp.respHtml.equals("mktm0090_detl")))
         {
          wp.initOption = "";
       ...
       if ((wp.respHtml.equals("mktm0090")))
         {
          wp.initOption ="--";
          wp.optionKey = "";
...
//************************************************************************
public void commDataCode342(String s1) throws Exception 
{
String columnData="";
String sql1 = "";
 for (int ii = 0; ii < wp.selectCnt; ii++)
   ...
   if (errorCnt ==0)
      {
       if (sysUploadAlias.equals("aaa1"))
          {
           if (func.dbInsertI2Aaa1("CYC_BN_DATA_T",uploadFileCol,uploadFileDat) == 1) {
               llOk++;
           } else {
               llErr++;
           }
...
// ************************************************************************
 public void checkButtonOff() throws Exception
  ...
  if (wp.colStr("platform_kind_sel").equals("0"))
     {
      buttonOff("btnmcgp2_disable");
     }
  else
     {
      wp.colSet("btnmcgp2_disable","");
     }
