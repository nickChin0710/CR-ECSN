...
// ************************************************************************
public class Mktm0380 extends BaseEdit {
  private String PROGNAME = "雙幣卡外幣刷卡金回饋參數檔維護處理程式108/12/12 V1.00.01";
  busi.ecs.CommFunction comm = new busi.ecs.CommFunction();
  busi.ecs.CommRoutine comr = null;
  mktm01.Mktm0380Func func = null;
  String rowid;
  String funcCode;
  String fstAprFlag = "";
  String orgTabName = "cyc_dc_fund_parm";
  ...
  public void queryRead() throws Exception {
    ...
    wp.selectSQL = " " + "hex(a.rowid) as rowid, " + "nvl(a.mod_seqno,0) as mod_seqno, "
        + "a.fund_code," + "a.fund_name," + "a.curr_code," + "a.fund_crt_date_s," + "a.stop_date,"
  ...
  public void dataRead() throws Exception {
    ...
    wp.selectSQL = "hex(a.rowid) as rowid," + " nvl(a.mod_seqno,0) as mod_seqno, "
        ...
        + "a.stop_flag," + "a.stop_date," + "a.stop_desc," + "a.curr_code," + "a.feedback_month_s,"
        + "a.feedback_month_e," + "a.effect_months," + "a.new_hldr_cond," + "a.new_hldr_days,"
        + "a.new_group_cond," + "a.new_hldr_card," + "a.new_hldr_sup," + "a.source_code_sel,"
        + "a.merchant_sel," + "a.mcht_group_sel," + " a.platform_kind_sel, "+ "a.group_card_sel," + "a.group_code_sel,"
        + "a.purchase_amt_s1," + "a.purchase_amt_e1," + "a.feedback_rate_1," + "a.purchase_amt_s2,"
        + "a.purchase_amt_e2," + "a.feedback_rate_2," + "a.purchase_amt_s3," + "a.purchase_amt_e3,"
        + "a.feedback_rate_3," + "a.purchase_amt_s4," + "a.purchase_amt_e4," + "a.feedback_rate_4,"
        + "a.purchase_amt_s5," + "a.purchase_amt_e5," + "a.feedback_rate_5," + "a.feedback_lmt,"
        + "a.issue_cond," + "a.issue_date_s," + "a.issue_date_e," + "a.issue_flag,"
        + "a.issue_num_1," + "a.issue_num_2," + "a.issue_num_3," + "a.crt_user," + "a.crt_date,"
  ...
  public void dataReadR3R() throws Exception {
    ...
    wp.selectSQL = "hex(a.rowid) as rowid," + " nvl(a.mod_seqno,0) as mod_seqno, "
        ...
        + "a.curr_code as curr_code," + "a.feedback_month_s as feedback_month_s,"
        + "a.feedback_month_e as feedback_month_e," + "a.effect_months as effect_months,"
        + "a.new_hldr_cond as new_hldr_cond," + "a.new_hldr_days as new_hldr_days,"
        + "a.new_group_cond as new_group_cond," + "a.new_hldr_card as new_hldr_card,"
        + "a.new_hldr_sup as new_hldr_sup," + "a.source_code_sel as source_code_sel,"
        + "a.merchant_sel as merchant_sel," + "a.mcht_group_sel as mcht_group_sel," + "a.platform_kind_sel as platform_kind_sel,"
        ...
        + "a.feedback_rate_1 as feedback_rate_1," + "a.purchase_amt_s2 as purchase_amt_s2,"
        + "a.purchase_amt_e2 as purchase_amt_e2," + "a.feedback_rate_2 as feedback_rate_2,"
        + "a.purchase_amt_s3 as purchase_amt_s3," + "a.purchase_amt_e3 as purchase_amt_e3,"
        + "a.feedback_rate_3 as feedback_rate_3," + "a.purchase_amt_s4 as purchase_amt_s4,"
        + "a.purchase_amt_e4 as purchase_amt_e4," + "a.feedback_rate_4 as feedback_rate_4,"
        + "a.purchase_amt_s5 as purchase_amt_s5," + "a.purchase_amt_e5 as purchase_amt_e5,"
        + "a.feedback_rate_5 as feedback_rate_5," + "a.feedback_lmt as feedback_lmt,"
        + "a.issue_cond as issue_cond," + "a.issue_date_s as issue_date_s,"
        + "a.issue_date_e as issue_date_e," + "a.issue_flag as issue_flag,"
        + "a.issue_num_1 as issue_num_1," + "a.issue_num_2 as issue_num_2,"
        + "a.issue_num_3 as issue_num_3," + "a.crt_user as crt_user," + "a.crt_date as crt_date,"
...
//    whereCnt += " and  data_key = '" + wp.itemStr("fund_code") + "'";
  ...
  public void updateFuncU2() throws Exception {
    mktm01.Mktm0380Func func = new mktm01.Mktm0380Func(wp);
    int llOk = 0, llErr = 0;
...
//    whereCnt += " and  data_key = '" + wp.itemStr("fund_code") +
  ...
  public void dddwSelect() {
    String lsSql = "";
    try {
      if ((wp.respHtml.equals("mktm0380_nadd")) || (wp.respHtml.equals("mktm0380_detl"))) {
        wp.optionKey = "";
        wp.initOption = "";
      ...
      if ((wp.respHtml.equals("mktm0380"))) {
        wp.initOption = "--";
        wp.optionKey = "";
      ...
      if ((wp.respHtml.equals("mktm0380_cocq"))) {
        wp.initOption = "";
        wp.optionKey = "";
        ...
        wp.initOption = "";
        wp.optionKey = "";
        this.dddwList("dddw_currcode", "ptr_currcode", "trim(curr_code)", "trim(curr_chi_name)",
            " where 1 = 1 ");
      }
    } catch (Exception ex) {
    }
...
//              + " and   mcht_group_id = '" + wp.colStr(ii, "data_code") + "'";
  ...
  int checkUploadfileAaa1(String tmpStr) throws Exception {
    ...
    uploadFileDat[2] = "CYC_DC_FUND_PARM";
...
{
 wp.colSet("source_code_sel_cnt" , listMktParmData("mkt_parm_data_t","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"3"));
 wp.colSet("merchant_sel_cnt" , listMktParmData("mkt_parm_data_t","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"4"));
 wp.colSet("mcht_group_sel_cnt" , listMktParmData("mkt_parm_data_t","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"6"));
 wp.colSet("platform_kind_sel_cnt" , listMktParmData("mkt_parm_data_t","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"P"));
 wp.colSet("group_code_sel_cnt" , listMktParmData("mkt_parm_data_t","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"2"));
 wp.colSet("group_card_sel_cnt" , listMktParmData("mkt_parm_data_t","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"1"));
}
//************************************************************************
void listWkdata() throws Exception
{
 wp.colSet("source_code_sel_cnt" , listMktParmData("mkt_parm_data","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"3"));
 wp.colSet("merchant_sel_cnt" , listMktParmData("mkt_parm_data","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"4"));
 wp.colSet("mcht_group_sel_cnt" , listMktParmData("mkt_parm_data","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"6"));
 wp.colSet("platform_kind_sel_cnt" , listMktParmData("mkt_parm_data","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"P"));
 wp.colSet("group_code_sel_cnt" , listMktParmData("mkt_parm_data","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"2"));
 wp.colSet("group_card_sel_cnt" , listMktParmData("mkt_parm_data","CYC_DC_FUND_PARM",wp.colStr("fund_code"),"1"));
}
//************************************************************************
