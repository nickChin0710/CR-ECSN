...
import mktm01.Mktm0040Func;
import ofcapp.AppMsg;
import java.util.Arrays;
import ofcapp.BaseEdit;
import taroko.com.TarokoCommon;
// ************************************************************************
public class Mktm0040 extends BaseEdit
{
 private final String PROGNAME = "紅利統計來源群組明細維護處理程式111-11-28  V1.00.01";
  busi.ecs.CommFunction comm = new busi.ecs.CommFunction();
  busi.ecs.CommRoutine comr = null;
  mktm01.Mktm0040Func func = null;
  String kk1;
  String orgTabName = "mkt_bonus_srcdtl";
...
// ************************************************************************
 ...
 public void queryFunc() throws Exception
 {
  wp.whereStr = "WHERE 1=1 "
              + sqlCol(wp.itemStr2("ex_tran_pgm"), "a.tran_pgm", "like%")
...
// ************************************************************************
 ...
 {
  if (qFrom==0)
  if (wp.itemStr2("kk_tran_pgm").length()==0)
     { 
      alertErr("查詢鍵必須輸入");
      return; 
     } 
  ...
  if (qFrom==0)
     {
       wp.whereStr = wp.whereStr
                   + sqlCol(wp.itemStr2("kk_tran_pgm"), "a.tran_pgm")
                   ;
     }
  else if (qFrom==1)
     {
...
// ************************************************************************
 ...
 {
  mktm01.Mktm0040Func func =new mktm01.Mktm0040Func(wp);
