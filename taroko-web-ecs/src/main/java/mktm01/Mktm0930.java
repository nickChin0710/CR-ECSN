...
* ---------  --------  -----------    ------------------------------------ *
* 112/07/05  V1.00.01   machao                   Initial                          *
***************************************************************************/
package mktm01;
...
// ************************************************************************
public class Mktm0930 extends BaseEdit {
  ...
  String fstAprFlag = "";
  String orgTabName = "MKT_DIGACCTVD_PARM";
...
// ************************************************************************
  ...
  public void saveFunc() throws Exception {
    mktm01.Mktm0930Func func = new mktm01.Mktm0930Func(wp);
  ...
  public void dddwSelect() {
	  try {
	      ...
	      if (wp.colStr("active_code").length() > 0) {
			...
			this.dddwList("dddw_active_code", "mkt_digacctvd_parm", "active_code", "active_name",
