...
* ---------  --------  ---------- ------------------------------------------ *
* 106-08-30  V1.00.00  Andy Liu   program initial                            *
* 106-12-14  V1.00.01  Andy		  update : ucStr==>zzStr                     *
* 109-05-06  V1.00.02  shiyuqi      updated for project coding standard      * 		
 *  109/12/30  V1.00.03    Zuwei       “卡務中心”改為”信用卡部”   *
 * 109-01-04  V1.00.03   shiyuqi       修改无意义命名                                                                                      *  
 * 112-07-12  V1.00.04   Ryan         刪除廠商(索引)、廠商代碼、廠商名稱、APS批號、密碼序號，修改退件原因、固定搜尋條件      *  
******************************************************************************/
package crdr01;
...
public class Crdr0210 extends BaseReport {

  InputStream inExcelFile = null;
  String mProgName = "crdr0210";
  ...
  private boolean getWhereStr() throws Exception {
    ...
    switch (exType) {
      case "1":
        lsWhere += " and a.combo_indicator = 'N' ";
        break;
      case "2":
        lsWhere += " and a.combo_indicator != 'N' ";
        break;
  ...
  public void queryRead() throws Exception {
    ...
    wp.selectSQL = "" + "a.vendor, " + "b.vendor_name, " + "a.batchno, " + "a.recno, "
        ...
        + "a.combo_indicator," + "'' wk_temp ";
    wp.daoTable = " crd_emboss a left join ptr_vendor_setting b on a.vendor = b.vendor ";
