...
public class SqlPrepare {
  ...
  public void addsqlParm(String sql1, String sql2, Object obj) {
    if (sql1.indexOf("?") >= 0) {
      addsql(sql2, sql1);
    } else
      addsql(sql1, sql2);
  ...
  // }
  // }
  public void addsqlParm(String sql1, String strName) {
    if (sqlInsert) {
      addsql(sql1, strName);
      return;
    }
  ...
  public void addsqlParm(String sql1, double strName) {
    addsql(sql1);
    if (sql1.indexOf("?") >= 0) {
      parmIndex++;
      sortHash.put(parmIndex, strName);
  ...
  public void addsqlParm(String sql1, int strName) {
    addsql(sql1);
    if (sql1.indexOf("?") >= 0) {
      parmIndex++;
      sortHash.put(parmIndex, strName);
  ...
  public void ppstr(String col) {
    ppstr(col, wp.itemStr(col));
  }

  public void ppnvl(String col, String strName) {
    ppstr(col, wp.itemNvl(col, strName));
  }

  public void ppstr2(String col, String strName) {
    ppstr(col, strName);
  }

  public void ppstr(String col, String strName) {
    if (sqlInsert) {
      sbSql1.append(", " + col);
      sbSql2.append(", ? ");
    } else if (sqlUpdate) {
  ...
  public void ppnum(String col) {
    ppnum(col, wp.itemNum(col));
  }

  public void ppdouble(String col, double num1) {
    if (sqlInsert) {
      sbSql1.append(", " + col);
      sbSql2.append(", ? ");
    } else if (sqlUpdate) {
  ...
  public void ppnum(String col, double num1) {
    if (sqlInsert) {
      sbSql1.append(", " + col);
      sbSql2.append(", ? ");
    } else if (sqlUpdate) {
  ...
  public void ppint2(String col, int num1) {
    ppint(col, num1);
  }

  public void ppint(String col, int num1) {
    if (sqlInsert) {
      sbSql1.append(", " + col);
      sbSql2.append(", ? ");
    } else if (sqlUpdate) {
  ...
  public Object[] sqlParm() {
    ...
    for (Object sortData : keys2) {
      param[ii++] = sortHash.get(sortData);
    }
    // sortHash.clear();
    return param;
  }
