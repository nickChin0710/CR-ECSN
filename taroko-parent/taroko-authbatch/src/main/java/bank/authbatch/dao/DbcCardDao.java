...
public class DbcCardDao extends AuthBatchDbHandler{

	public DbcCardDao()  throws Exception{
		// TODO Auto-generated constructor stub
	}

	static String sG_SqlSelectDataByCardNo = "select NEW_END_DATE as CardNewEndDate, BIN_TYPE as CardBinType, "
	...
	static PreparedStatement G_SelectPsByCardNo = null;
	...
	public static boolean updateDbcCard(String sP_CardNo, String sP_NewValueOfOldEndDate) {
		boolean bL_Result=true;
		try {
			String sL_Sql = "UPDATE DBC_CARD "
	...
	/*
	public static boolean updateDbcCardBlockCode(String sP_CardNo, String sP_NewBlockCode, String sP_CurDate) {
		boolean bL_Result=true;
		try {
	...
	*/
	...
	public static ResultSet getDbcCardByCardNo_Old(String sP_CardNo) {
	...
	public static ResultSet getDbcCardByCardNo(String sP_CardNo) {
		ResultSet L_ResultSet = null;
		try {
			
			if (null == G_SelectPsByCardNo)
				G_SelectPsByCardNo = getDbConnection().prepareStatement(sG_SqlSelectDataByCardNo);
			G_SelectPsByCardNo.setString(1, sP_CardNo);
			
			L_ResultSet = G_SelectPsByCardNo.executeQuery();
	...
	public static ResultSet getDbcCard(String sP_CardStatus, int nP_Type, String sP_DbOpenDate, String sP_ActivateDate01, String sP_ActivateDate31, String sP_DbProcDate, String sP_DbCardTo, String sP_DbCardFrom) {
	...
	public static ResultSet getDbcCard(String sP_IdNo) {
		
		ResultSet L_ResultSet = null;
		try {
			String sL_Sql="select A.CARD_TYPE from DBC_CARD A, CRD_IDNO B "
