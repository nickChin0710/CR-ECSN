 ...
 *  ---------  --------- ----------- -------------------------------------------------------------------------  *
 *  112/04/24  V1.00.00    Bo Yang                 program initial                                              *             
 *  112/04/27  V1.00.00.01 Grace Huang             調整 selectActAcno(), table_name, data_key 條件應為大寫                                 *
 *  112/06/16  V1.00.00.02 Grace Huang             增mcht_chi_name, 做為排除非一般消費檢核                                                                                   *
 *  112/06/16  V1.00.00.03 Bo Yang                 參數未輸入時, hProcDate取bussiness_date                           *
 *  112/09/11  V1.00.00.04 Grace Huang             變更 FILE_NAME_AP4 ("AW-AP4-CRYYYYMMDD.01") 檔案目錄至/crdatacrea  *  
 *  112/12/04  V1.00.00.05 Zuwei Su                errExit改為 show message & exit program  *  
 *  112/12/19  V1.00.00.06  Zuwei Su     errRtn改為 show message & exit program  *  
 *  112/12/28  V1.00.00.07  Zuwei Su     method有error後正常退出執行  *  
 *  113/01/05  V1.00.00.08  Zuwei Su     return值返回0  *  
 *****************************************************************************************************************/
package Mkt;
...
public class MktC920 extends AccessDAO {
    private final String PROGNAME = "金庫幣活動-申辦電子帳單回饋篩選處理 112/06/16 V1.00.00.06 ";
    ...
    private final static String MOD_PGM = "MktC920";
...
//                comc.errExit("Usage : MktC920 [sysdate ex:yyyymmdd] ", "");
                showLogMessage("I", "", "Usage : MktC920 [sysdate ex:yyyymmdd] ");
                return 0;
            }
