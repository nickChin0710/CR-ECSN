...
*  112/09/04 V1.01.02  Kirin       change introduce_emp_no                    *
*  112/11/24 V1.01.03  Kirin       每月2日執行 專案代碼=2023010001                  *
******************************************************************************/
package Mkt;
...
public class MktRF71A extends AccessDAO {
    private String PROGNAME = "員工推展┌ VISA萬事達漢來美食卡 ┘獎勵統計表  112/09/04 V1.01.02";
...
//    String PgmCd     = "2023010002";
    ...
    String rptIdR1   = "CRF71A";
    String rptName1  = "員工推展┌ VISA萬事達漢來美食卡 ┘獎勵統計表";
 ...
 try 
   {
    ...
    // =====================================
    if(args.length > 3 ) {
       comc.errExit("Usage : MktRF71A [PROGRAM_CODE] [yyyymmdd] [seq_no] ", "");
      }
/*
...
if(DEBUG_F==1) showLogMessage("I","","   Write HEAD=["+idx+"]");
     ...
     buf = comcr.insertStr(buf, "報表代號: CRF71A   科目代號:"   ,  1);
