...
*  --------- --------- ----------- -----------------------------------------  *
*  112/08/07 V1.01.01  Lai         program initial                            *
*  112/11/24 V1.01.02  Kirin       每月2日執行 專案代碼=2023010001                  *                                                                             *
******************************************************************************/
package Mkt;
...
public class MktRF694A extends AccessDAO {
    private String PROGNAME = "員工推展┌卡娜赫拉的小動物悠遊聯名卡┘獎勵統計表  112/08/07 V1.01.01";
...
//    String rptIdR1   = "RCRF694A.1";
    String rptIdR1   = "CRF694A";
    String rptName1  = "員工推展┌卡娜赫拉的小動物悠遊聯名卡┘獎勵統計表";
 ...
 try 
   {
    ...
    // =====================================
    if(args.length > 3 ) {
       comc.errExit("Usage : MktRF694A [PROGRAM_CODE] [yyyymmdd] [seq_no] ", "");
      }
/*
...
{
//   filename_o = String.format("%s/media/mkt/%s.txt",comc.getECSHOME(), rptIdR1);
...
if(DEBUG_F==1) showLogMessage("I","","   Dtl="+BrnCnt+","+allData_int[BrnCnt][1]+","+allData_int[BrnCnt][2]+","+allData_int[BrnCnt][3]);
    }
...
if(DEBUG_F==1) showLogMessage("I","","   Write HEAD=["+idx+"]");
     ...
     buf = comcr.insertStr(buf, "報表代號: CRF694A   科目代號:"   ,  1);
