...
*  112/09/02 V1.01.04  Kirin       change EmplId                              *
...
public class MktRF615A extends AccessDAO {
    private String PROGNAME = "員工推展┌ VISA御璽房貸卡 ┘獎勵統計表  112/08/07 V1.01.01";
    ...
    int    DEBUG    = 0;
    int    DEBUG_F  = 0;
    String prgmId    = "MktRF615A";
    String hTempUser = "";

    int    Report_Page_Line = 45;
//    String PgmCd     = "2023010002";
    String PgmCd     = "2023010001";
    String rptIdR1   = "CRF615A";
    String rptName1  = "員工推展┌ VISA御璽房貸卡 ┘獎勵統計表";
 ...
 try 
   {
    ...
    // =====================================
    if(args.length > 3 ) {
       comc.errExit("Usage : MktRF615A [PROGRAM_CODE] [yyyymmdd] [seq_no] ", "");
      }
/*
...
if(DEBUG_F==1) showLogMessage("I","","   Write HEAD=["+idx+"]");
     ...
     buf = comcr.insertStr(buf, "報表代號: CRF615A   科目代號:"   ,  1);
