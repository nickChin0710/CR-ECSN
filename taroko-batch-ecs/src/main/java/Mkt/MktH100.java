...
public class MktH100 extends AccessDAO
{
 private  String progname = "基金-指定一般基金無效卡達三個月移除處理程式 109/12/09 V1.00.01";
 ...
 void  selectMktCashbackDtl() throws Exception
 {
  ...
  while( fetchTable() ) 
   { 
    ...
    if (intk==-1)
       {
        showLogMessage("I","","基金代碼["+ getValue("fund_code") +"] bot found !");
        continue;
       }
...
//        setValue("fund.cd_kind"              , getValue("parm.rem_vouch_no",inti));
//    else
