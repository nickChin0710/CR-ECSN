...
public class MktFr15 extends AccessDAO {
    private final String PROGNAME = "接收AP4傳送的個人房貸繳息正常戶名單處理程式 112/07/25 V1.00.00";
    ...
    private static final String FILE_NAME = "LACRHOU-YYYYMM.TXT";
    ...
    public int mainProcess(String[] args) {
        try {
            ...
            String fileName = FILE_NAME.replace("YYYYMM", dataMonth);
