...
*  --------- ----------  ----------- ---------------------------------------- *
*  112/07/21 V1.01.01    Lai         Program initial                          *
...
public class MktE070 extends BaseBatch {
    private final String PROGNAME = "卡友各項權益統計-高鐵接送(type:xx)   112/07/21 V1.01.01";
    ...
    String prgmId   = "MktE070";
    String rptName  = "高鐵接送";
    String rptId    = "MktE070R0";
    int    rptSeq   = 0;
...
public int mainProcess(String[] args) 
{
        try {
            ...
            if (args.length >  2) 
                commCrd.errExit(String.format("Usage : MktE070 [BUSINESS_DATE][Y]"),"");
