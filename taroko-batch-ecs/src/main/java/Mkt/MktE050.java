...
public class MktE050 extends BaseBatch {
    private final String PROGNAME = "卡友各項權益統計--高鐵升等(type:xx)  112/07/21 V1.01.01";
    ...
    String prgmId   = "MktE050";
    String rptName  = "高鐵升等";
    String rptId    = "MktE050R0";
    int    rptSeq   = 0;
...
public int mainProcess(String[] args) 
{
        try {
            ...
            if (args.length >  2) 
                commCrd.errExit(String.format("Usage : MktE050 [BUSINESS_DATE][Y]"),"");
