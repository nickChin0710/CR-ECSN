...
public class MktC925a extends AccessDAO {

	public final boolean debugD = false;

	private String progname = "金庫幣活動-全新戶自動扣繳 回饋篩選處理 113/01/05  V1.00.00 ";
	...
	private final static String MOD_PGM = "MktC925a";
	int debug = 0;
...
//				comc.errExit("Usage : MktC925 [sysdate ex:yyyymmdd] ", "");
                showLogMessage("I", "", "Usage : MktC925a [sysdate ex:yyyymmdd] ");
                exitProgram(1);
			}
