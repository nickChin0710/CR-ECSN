...
public class InfC027 extends BaseBatch {
	private final String progname = "產生送CRDB 27異動英文戶名資料檔程式   112/10/26 V1.00.02";
	...
	protected void dataProcess(String[] args) throws Exception {
		...
		isFileName = "CRU23B1_TYPE_27_" + hChgDate + ".txt";
	...
	void writeText() throws Exception {
	    ...
	    sqlCmd += " ,(CASE WHEN a.debit_flag = 'Y' THEN (select eng_name from dbc_card where card_no = a.card_no) ";
	    sqlCmd += " WHEN a.debit_flag != 'Y' THEN (select eng_name from crd_card where card_no = a.card_no) END) as h_eng_name ";
