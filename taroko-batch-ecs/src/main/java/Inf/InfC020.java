...
*  ---------  --------- ----------- ---------------------------------------- *
*  110/08/13  V1.00.00   Castor     program initial                          *
*                                                                            *
*****************************************************************************/
package Inf;
...
public class InfC020 extends AccessDAO {
  private final String progname = "產生送CRDB 20更新自動扣繳註記資料檔程式 110/08/13 V1.00.00";
  private String prgmId = "InfC020";
  ...
  private final String fileName = "CRU23B1_TYPE_20_";
  ...
  public int mainProcess(String[] args) {
    ...
    try {
      ...
      List<ChgObj020> chgObjList = findChgObjList(searchDate);
		...
		// open CRU23B1_TYPE_20_yyyymmdd.txt file
   ...
   * @throws Exception
   */
  private List<ChgObj020> findChgObjList(String searchDate) throws Exception {
    ...
    List<ChgObj020> chgObjList = new LinkedList<ChgObj020>();
    ChgObj020 chgObj = null;

    for (int i = 0; i < selectCount; i++) {
    	
      chgObj = new ChgObj020();
   ...
   */
  private String getOutputString(List<ChgObj020> chgObjList) throws UnsupportedEncodingException {
	byte[] lineSeparatorArr = {'\r','\n'}; //0D0A
	String nextLine = new String(lineSeparatorArr,"MS950");
	
    StringBuilder sb = new StringBuilder();

    for (ChgObj020 chgObj : chgObjList) {
      ...
      sb.append(comc.fixLeft(hCrracf, 1));
