...
public class InfC022 extends BaseBatch {
	private final String progname = "產生送CRDB 22異動中文戶名資料檔程式   112/10/26 V1.00.03";
	...
	protected void dataProcess(String[] args) throws Exception {
		...
		isFileName = "CRU23B1_TYPE_22_" + hChgDate + ".txt";
	...
	void writeText() throws Exception {
	    ...
	    sqlCmd += " ,decode(a.debit_flag,'Y',UF_VD_IDNO_NAME(a.id_p_seqno),UF_IDNO_NAME(a.id_p_seqno)) as h_chi_name ";
	    sqlCmd += " from cms_chgcolumn_log as a ";
		sqlCmd += " where a.chg_date = ? ";
		sqlCmd += " and a.chg_column = 'chi_name' ";
