 ...
 *  ---------  --------- ----------- ----------------------------------------  *
 *  108/02/19  V1.01.00   Brian      program initial                           *
...
public class IchF0a6 extends AccessDAO {
    private String progname = "持卡人資料補充(B96B)媒體處理  109/12/16 V1.01.01";
    ...
    public int mainProcess(String[] args)
    {
        try
        {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : IchF0a6 [notify_date [force_flag]]", "");
            }
...
//      updateSQL += " proc_flag     = 'N',";
        ...
        setString(5, hRetdIdNo );
        setString(6, hTnlgFileName);
        updateTable();
        if (notFound.equals("Y")) {
            comcr.errRtn("update_ich_b96b_idno not found!", hRetdIdNo
    ...
    void splitBuf1(String str) throws UnsupportedEncodingException {
        ...
        dtl1.idNo  = comc.subMS950String(bytes,  1,  20);
        dtl1.rtnCode    = comc.subMS950String(bytes, 21,  1);
        dtl1.filler1  = comc.subMS950String(bytes, 22,  26);
