...
public class IchF029 extends AccessDAO {
    private String progname = "餘額返還卡片最後一筆扣款交易紀錄(A09B)接收處理  109/12/16 V1.00.01";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : IchF029 [[notify_date][fo1yy_flag]] [force_flag]", "");
            }
