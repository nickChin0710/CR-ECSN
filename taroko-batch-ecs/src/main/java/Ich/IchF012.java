...
public class IchF012 extends AccessDAO {
    private String progname = "製卡回饋檔(B02B)媒體處理  109/12/15 V1.00.01";
 ...
 try
  {
   ...
   if (args.length != 0 && args.length != 1 && args.length != 2) {
       comc.errExit("Usage : IchF012 [notify_date [force_flag]]", "");
   }
...
//      updateSQL += " proc_flag     = 'N',";
        ...
        updateTable();
        if (notFound.equals("Y")) {
            comcr.errRtn("update_ich_b02b_fback not found!", hRetdIchCardNo
