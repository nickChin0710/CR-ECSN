...
public class IchF016 extends AccessDAO {
    private String progname = "卡人資料檔(B06B)媒體處理  109/12/16 V1.01.01";
    ...
    public int mainProcess(String[] args)
    {
        try
        {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : IchF016 [notify_date [force_flag]]", "");
            }
...
//      updateSQL += " proc_flag     = 'N',";
        ...
        updateTable();
        if (notFound.equals("Y")) {
            comcr.errRtn("update_ich_b06b_idno not found!", hRetdIchCardNo
    ...
    void splitBuf1(String str) throws UnsupportedEncodingException {
        ...
        dtl1.filler1   = comc.subMS950String(bytes, 31, 29);
        dtl1.opKind   = comc.subMS950String(bytes, 60,  1);
