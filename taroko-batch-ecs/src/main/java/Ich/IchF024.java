...
public class IchF024 extends AccessDAO {
    private String progname = "異常交易檔(A04B)接收處理  109/12/16 V1.00.01";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : IchF024 [[notify_date][fo1yy_flag]] [force_flag]", "");
            }
    ...
    void fileOpen() throws Exception {
        ...
        while (true) {
            ...
            hIcgeIchCardNo = comc.rtrim(dtl.ichCardNo);
            ...
            /* effc_date 暫不檢核 mark by brian 20190507 */
            //tmpstr1 = String.format("%s", comc.rtrim(dtl.effc_date));
            //if (comm.checkDateFormat(tmpstr1, "yyyyMMdd") == false) {
            //    h_orgd_rpt_resp_code = "1";
            //    insert_ich_orgdata_log();
            //    continue;
            //}
    ...
    void splitBuf1(String str) throws UnsupportedEncodingException {
        ...
        dtl.txnCode = comc.subMS950String(bytes, 35, 2);
