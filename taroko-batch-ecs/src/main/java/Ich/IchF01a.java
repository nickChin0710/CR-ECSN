...
public class IchF01a extends AccessDAO {
    private String progname = "每月簽帳資料檔(B10B)媒體處理  109/12/16 V1.01.01";
    ...
    public int mainProcess(String[] args)
    {
        try
        {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : IchF01a [notify_date [force_flag]]", "");
            }
    ...
    void selectIchNotifyLog() throws Exception
    {
        ...
        sqlCmd += "  and file_iden   = 'B10B' ";
        sqlCmd += "  and notify_date = decode(cast(? as varchar(8))  , '', notify_date,cast(? as varchar(8))) ";
...
// 1. xRQx/xRPx,xxxQ/xxxR  ex. BRQA, BRPA      2. FC, FB
        ...
        while (true) {
            ...
            if (str600.substring(0, 1).equals("D"))     totCnt++;
...
//      updateSQL += " proc_flag     = 'N',";
        ...
        updateTable();
        if (notFound.equals("Y")) {
            comcr.errRtn("update_ich_b10b_month not found!", hRetdIchCardNo
    ...
    void splitBuf1(String str) throws UnsupportedEncodingException {
        ...
        dtl1.rtnCode   = comc.subMS950String(bytes, 17,  1);
        dtl1.filler1   = comc.subMS950String(bytes, 18, 30);
        dtl1.sysDate  = comc.subMS950String(bytes, 48,  8);
        dtl1.sysTime  = comc.subMS950String(bytes, 56,  6);
