...
public class IchF02a extends AccessDAO {
    private String progname = "聯名卡帳務調整清分明細(A10B)接收處理  109/12/16 V1.00.01";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : IchF02a [[notify_date][fo1yy_flag]] [force_flag]", "");
            }
