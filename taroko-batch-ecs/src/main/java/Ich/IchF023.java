...
public class IchF023 extends AccessDAO {
    private String progname = "鎖卡資料拋轉(A03B)接收處理  109/12/16 V1.00.01";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : IchF023 [[notify_date][fo1yy_flag]] [force_flag]", "");
            }
