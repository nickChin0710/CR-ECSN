...
/*掛失贖回餘額交易資料檔(BDEC)接收檢核*/
public class TscF02b extends AccessDAO {
    private final String progname = "掛失贖回餘額交易資料檔(BDEC)接收檢核  109/11/17 V1.00.01";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2 && args.length != 3) {
                comc.errExit("Usage : TscF02b [[notify_date][fo1yy_flag]] [force_flag][seq(nn)]", "");
            }
