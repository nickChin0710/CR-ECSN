...
public class TscD03a extends AccessDAO {
    private final String progname = "悠遊VD卡餘額轉置請款檔(DCBE)媒體接收處理程式  110/01/22 V1.00.00";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2 && args.length != 3) {
                comc.errExit("Usage : TscD03a [[notify_date][fo1yy_flag]] [force_flag][seq(nn)]", "");
            }
