 ...
 *  110/01/12  V1.00.04    Wilson    修正bug2                                   *
 ******************************************************************************/
...
/*悠遊卡銀行回覆資料檔(ECTI)媒體RPT處理程式*/
public class TscF013 extends AccessDAO {

    private final String progname = "悠遊卡銀行回覆資料檔(ECTI)媒體RPT處理程式  110/01/12 V1.00.04";
    ...
    String hEctiRptRespCode = "";
    String hEctiRptRespDate = "";
    String hEctiRptRespTime = "";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : TscF013 [notify_date [force_flag]]", "");
            }
    ...
    void fileOpen2() throws Exception {
        ...
        while (true) {
            ...
            hEctiTscCardNo = tmpstr1.substring(0, inta + 1);
            ...
            hEctiTranDate = tmpstr1.substring(0, inta + 1);
            ...
            hEctiTranTime = tmpstr1.substring(0, inta + 1);

            showLogMessage("I", "", String.format("Line [%08d][%s][%s][%s] resp_code[%s] error!", totalCnt,
                    hEctiTscCardNo, hEctiTranDate, hEctiTranTime, hEctiRptRespCode));
    ...
    void updateTscEctiLog() throws Exception {
        ...
        updateSQL += " mod_pgm  = 'TscF013',";
        updateSQL += " mod_time = sysdate";
        whereStr = "where tsc_card_no = ?  ";
        whereStr += " and tran_date = ?  ";
        whereStr += " and tran_time = ?  ";
        whereStr += " and file_name = ? ";
        setString(1, hEctiRptRespCode);
        setString(2, hEctiRptRespDate);
        setString(3, hEctiRptRespTime);
        setString(4, hEctiTscCardNo);
        setString(5, hEctiTranDate);
        setString(6, hEctiTranTime);
