...
public class TscD028 extends AccessDAO {

    private final String progname = "悠遊VD卡掛失贖回餘額資料檔(DCBD)媒體接收檢核程式  110/01/14 V1.00.00";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2 && args.length != 3) {
                comc.errExit("Usage : TscD028 [[notify_date][fo1yy_flag]] [force_flag][seq(nn)]", "");
            }
