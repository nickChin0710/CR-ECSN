...
public class TscD015 extends AccessDAO {

    private final String progname = "悠遊VD卡餘額轉置通知檔(DCBQ)媒體RPT處理程式  110/01/08 V1.00.00";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : TscD015 [notify_date [force_flag]]", "");
            }
    ...
    void fileOpen2() throws Exception {
        ...
        while (true) {
            ...
            hDcbqRptRespCode = comc.rtrim(dtl.rptRespCode);
            hDcbqTscCardNo = comc.rtrim(dtl.tscCardNo);

            showLogMessage("I", "", String.format("Line [%08d][%s] resp_code[%s] error!", totalCnt, hDcbqTscCardNo,
                    hDcbqRptRespCode));
