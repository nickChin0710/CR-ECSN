...
public class TscD02b extends AccessDAO {
    private final String progname = "悠遊VD卡掛失贖回餘額交易資料檔(DCDE)媒體接收檢核程式  110/01/14 V1.00.00";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2 && args.length != 3) {
                comc.errExit("Usage : TscD02b [[notify_date][fo1yy_flag]] [force_flag][seq(nn)]", "");
            }
            ...
            tmpstr1 = String.format("DCDE.%8.8s.%8.8s%2.2s", comc.TSCC_BANK_ID8, hTempNotifyDate, fileSeq);
