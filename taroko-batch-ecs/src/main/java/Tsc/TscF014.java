...
/*悠遊卡卡號資料檔(CDNR)媒體RPT處理程式*/
public class TscF014 extends AccessDAO {

    private final String progname = "悠遊卡卡號資料檔(CDNR)媒體RPT處理程式  110/01/11 V1.00.03";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : TscF014 [notify_date [force_flag]]", "");
            }
    ...
    void fileOpen2() throws Exception {
        ...
        while (true) {
            ...
            hCdnrRptRespCode = comc.rtrim(dtl.rptRespCode);
            hCdnrTscCardNo = comc.rtrim(dtl.tscCardNo);
            hCdnrIcSeqNo = comc.rtrim(dtl.icSeqNo);
            ...
            showLogMessage("I", "", String.format("Line [%08d][%s] resp_code[%s] error!", totalCnt, hCdnrTscCardNo,
                    hCdnrRptRespCode));
