...
*  110/01/22  V1.00.02    Wilson    修正bug                                    *
*                                                                             *
******************************************************************************/
...
/*tsc_f03a(BPEC)接收處理*/
public class TscF03a extends AccessDAO {
    private final String progname = "TscF03a(BPEC)接收處理  110/01/22 V1.00.02";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2 && args.length != 3) {
                comc.errExit("Usage : TscF03a [[notify_date][fo1yy_flag]] [force_flag][seq(nn)]", "");
            }
            ...
            tmpstr1 = String.format("BPEC.%8.8s.%8.8s%2.2s", comc.TSCC_BANK_ID8, hTempNotifyDate, fileSeq);
    ...
    int selectTscCard() throws Exception {
        ...
        if (recordCnt > 0) {
            ...
            hTardCurrenCode = getValue("current_code");
    ...
    void initTscMinusLog() throws Exception {
        ...
        hCgecTscNotiDate = "";
        hCgecTscRespCode = "";
        hCgecReturnSource = "03a";

    }

    /***********************************************************************/
    public static void main(String[] args) throws Exception {
        TscF03a proc = new TscF03a();
