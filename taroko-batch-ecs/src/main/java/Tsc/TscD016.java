...
/*悠遊VD卡簽帳資料檔(DCST)媒體RPT處理程式*/
public class TscD016 extends AccessDAO {

    private final String progname = "悠遊VD卡簽帳資料檔(DCST)媒體RPT處理程式  110/01/12 V1.00.01";
    ...
    String hDcstRptRespCode = "";
    String hDcstRptRespDate = "";
    String hDcstRptRespTime = "";
    ...
    void fileOpen2() throws Exception {
        ...
        while (true) {
            ...
            hDcstTscCardNo = tmpstr1.substring(0, inta);

            showLogMessage("I", "", String.format("Line [%08d][%s] resp_code[%s] error!", totalCnt,
                    hDcstTscCardNo, hDcstRptRespCode));
    ...
    void updateTscDcstLog() throws Exception {
        ...
        setString(1, hDcstRptRespCode);
        setString(2, hDcstRptRespDate);
        setString(3, hDcstRptRespTime);
        setString(4, javaProgram);
        setString(5, hDcstTscCardNo);
