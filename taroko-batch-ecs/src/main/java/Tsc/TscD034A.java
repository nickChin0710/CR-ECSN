...
public class TscD034A extends AccessDAO {

	private final String progname = "悠遊VD卡鎖卡資料檔(DCLK)媒體接收處理程式  112/05/05 V1.00.08";
	...
	public int mainProcess(String[] args) {
		...
		try {
			...
			if (args.length == 0) {
				...
				comc.errExit("Usage : TscD034A [[notify_date][force_flag]] [force_flag]", "");
			}
