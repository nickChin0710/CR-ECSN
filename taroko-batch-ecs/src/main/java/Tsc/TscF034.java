...
public class TscF034 extends AccessDAO {

  private final String progname = "悠遊卡黑名單鎖卡資料檔(LKEC)媒體接收處理程式  111/02/14 V1.00.09";
...
//        comc.errExit("Usage : TscF034 [[notify_date][force_flag]] [force_flag]", "");
//      }
