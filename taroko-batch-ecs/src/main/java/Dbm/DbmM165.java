...
* 112/11/15  V1.00.02    Ryan     調整活動名稱                                                         *
******************************************************************************/
package Dbm;
...
public class DbmM165 extends AccessDAO
{
 private final String PROGNAME = "Debit紅利-請款新增點數處理程式 112/11/15  V1.00.02";
