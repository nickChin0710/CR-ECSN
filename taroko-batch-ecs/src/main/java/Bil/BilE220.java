...
public class BilE220 extends BilE200 {
    private  final String PROGNAME = "公用事業費用請款(補檔) 112/08/30 V1.00.03";
    ...
    protected int inputFileProcess() throws Exception {
        ...
        sqlCmd += " and file_name like 'PUCARD_IN_ADD.%' ";
...
//    };
	...
	int open_file() throws Exception {
		outputFileName = String.format("PUCARD_OUT_ADD.TXT");
