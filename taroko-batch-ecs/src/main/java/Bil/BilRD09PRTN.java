...
/*國際信用卡清算明細表-悠遊卡問題交易*/
public class BilRD09PRTN extends AccessDAO {
    private String progname = "列印國際信用卡清算明細表-悠遊卡問題交易程式  112/11/27  V1.00.02";
    CommFunction   comm  = new CommFunction();
    CommCrd        comc  = new CommCrd();
    CommCrdRoutine comcr = null;

    String prgmId = "BilRD09PRTN";
    String prgmName = "列印國際信用卡清算明細表-悠遊卡問題交易程式";
    String rptName = "國際信用卡清算明細表-悠遊卡問題交易";
    String rptId = "D09_PRTN";
    int rptSeq = 0;
	...
	void procVouchData() throws Exception {
		...
		tmpstr = String.format("D09PRTN_%s.%s_%s","C02", hVouchCdKind, hPcceCurrCodeGl);  
		comcr.hGsvhModPgm = tmpstr;
		comcr.hGsvhModWs = "BIL_PRTN";
    ...
    public static void main(String[] args) throws Exception {
        BilRD09PRTN proc = new BilRD09PRTN();
