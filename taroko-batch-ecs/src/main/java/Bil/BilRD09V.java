...
public class BilRD09V extends AccessDAO {
    ...
    void printFooter() {
    	...
    	buf = comcr.insertStr(buf, "金額", 114);
    	lpar1.add(comcr.putReport(rptId, rptName, sysDate, ++rptSeq, "0", buf));
