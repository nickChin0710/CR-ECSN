...
/*國際信用卡清算明細表-悠遊卡餘額轉置*/
public class BilRD09BTRP extends AccessDAO {
    private String progname = "列印國際信用卡清算明細表-悠遊卡餘額轉置程式  112/11/27  V1.00.02";
    CommFunction   comm  = new CommFunction();
    CommCrd        comc  = new CommCrd();
    CommCrdRoutine comcr = null;

    String prgmId = "BilRD09BTRP";
    String prgmName = "列印國際信用卡清算明細表-悠遊卡餘額轉置程式";
    String rptName = "國際信用卡清算明細表-悠遊卡餘額轉置";
    String rptId = "D09_BTRP";
    int rptSeq = 0;
	...
	void procVouchData() throws Exception {
		...
		tmpstr = String.format("D09BTRP_%s.%s_%s","C02", hVouchCdKind, hPcceCurrCodeGl);  
		comcr.hGsvhModPgm = tmpstr;
		comcr.hGsvhModWs = "BIL_BTRP";
    ...
    public static void main(String[] args) throws Exception {
        BilRD09BTRP proc = new BilRD09BTRP();
