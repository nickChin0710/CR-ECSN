...
/*國際信用卡清算明細表-悠遊卡加值*/
public class BilRD09RTEC extends AccessDAO {
    private String progname = "列印國際信用卡清算明細表-悠遊卡退卡資料程式  112/11/27  V1.00.02";
    CommFunction   comm  = new CommFunction();
    CommCrd        comc  = new CommCrd();
    CommCrdRoutine comcr = null;

    String prgmId = "BilRD09RTEC";
    String prgmName = "列印國際信用卡清算明細表-悠遊卡退卡程式";
    String rptName = "國際信用卡清算明細表-悠遊卡退卡";
    String rptId = "D09_RTEC";
    int rptSeq = 0;
	...
	void procVouchData() throws Exception {
		...
		tmpstr = String.format("D09RTEC_%s.%s_%s","C02", hVouchCdKind, hPcceCurrCodeGl);  
		comcr.hGsvhModPgm = tmpstr;
		comcr.hGsvhModWs = "BIL_RTEC";
    ...
    public static void main(String[] args) throws Exception {
        BilRD09RTEC proc = new BilRD09RTEC();
