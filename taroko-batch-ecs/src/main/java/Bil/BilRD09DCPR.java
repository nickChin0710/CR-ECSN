...
/*國際信用卡清算明細表-VD悠遊卡問題交易*/
public class BilRD09DCPR extends AccessDAO {
    private String progname = "列印國際信用卡清算明細表-悠遊卡問題交易程式  112/11/27  V1.00.02";
    CommFunction   comm  = new CommFunction();
    CommCrd        comc  = new CommCrd();
    CommCrdRoutine comcr = null;

    String prgmId = "BilRD09DCPR";
    String prgmName = "列印國際信用卡清算明細表-VD悠遊卡問題交易程式";
    String rptName = "國際信用卡清算明細表-VD悠遊卡問題交易";
    String rptId = "D09_DCPR";
    int rptSeq = 0;
    ...
    void printHeader() {
        ...
        buf = comcr.insertStr(buf, "處理結果", 99);  //4
    ...
    void printFooter() {
        ...
        buf = "";
        buf = comcr.insertStr(buf, "問題交易帳款合計:", 1);
        ...
        buf = "";
        buf = comcr.insertStr(buf, "問題交易剔退合計:", 1);
    ...
    void printDetail(String orgData) throws Exception {
        ...
        String onlineMark = comc.subMS950String(bytes, 104, 1);
        
        int destAmt = comc.str2int(destinationAmt);
        ...
        buf = comcr.insertStr(buf, getValue("rpt_resp_code"), 101); //處理結果
	...
	void procVouchData() throws Exception {
		...
		vouchCRAmt[4]  = totalTWDDestAmtDR;
		...
		tmpstr = String.format("D09DCPR_%s.%s_%s","C02", hVouchCdKind, hPcceCurrCodeGl);  
		comcr.hGsvhModPgm = tmpstr;
		comcr.hGsvhModWs = "BIL_DCPR";
    ...
    public static void main(String[] args) throws Exception {
        BilRD09DCPR proc = new BilRD09DCPR();
