...
/*國際信用卡清算明細表-悠遊卡加值*/
public class BilRD09TS extends AccessDAO {
    private String progname = "列印國際信用卡清算明細表-悠遊卡加值程式  112/11/27  V1.00.03";
    CommFunction   comm  = new CommFunction();
    CommCrd        comc  = new CommCrd();
    CommCrdRoutine comcr = null;

    String prgmId = "BilRD09TS";
    String prgmName = "列印國際信用卡清算明細表-悠遊卡加值程式";
    String rptName = "國際信用卡清算明細表-悠遊卡加值";
    String rptId = "BILR_D09_TS";
    int rptSeq = 0;
	...
	void procVouchData() throws Exception {
		...
		tmpstr = String.format("D09CGEC_%s.%s_%s","C02", hVouchCdKind, hPcceCurrCodeGl);  
		comcr.hGsvhModPgm = tmpstr;
		comcr.hGsvhModWs = "BIL_CGEC";
