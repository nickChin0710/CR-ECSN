...
/*國際信用卡清算明細表-信用卡*/
public class BilRD09U extends AccessDAO {
    private String progname = "列印國際信用卡清算明細表-信用卡USD程式  112/03/22  V1.00.01";
    CommFunction   comm  = new CommFunction();
    CommCrd        comc  = new CommCrd();
    CommCrdRoutine comcr = null;

    String prgmId = "BilRD09U";
    String prgmName = "列印國際信用卡清算明細表-信用卡USD程式";
    String rptName = "國際信用卡清算明細表-信用卡USD";
    String rptId = "BILR_D09_USD";
    int rptSeq = 0;
    List<Map<String, Object>> lpar1 = new ArrayList<Map<String, Object>>();
    
    String rptNameD02 = "國際信用卡清算彙計表-信用卡USD";
    String rptIdD02 = "CRD02_USD";
    int rptSeqD02 = 0;
    ...
    void printHeader() {
        ...
        buf = comcr.insertStrCenter(buf, "國際信用卡清算明細表-信用卡USD", 132);
