...
/*國際信用卡清算明細表-悠遊卡掛失餘轉*/
public class BilRD09BTRD extends AccessDAO {
    private String progname = "列印國際信用卡清算明細表-悠遊卡掛失餘轉程式  112/11/27  V1.00.02";
    CommFunction   comm  = new CommFunction();
    CommCrd        comc  = new CommCrd();
    CommCrdRoutine comcr = null;

    String prgmId = "BilRD09BTRD";
    String prgmName = "列印國際信用卡清算明細表-悠遊卡掛失餘轉程式";
    String rptName = "國際信用卡清算明細表-悠遊卡掛失餘轉";
    String rptId = "D09_BTRD";
    int rptSeq = 0;
	...
	void procVouchData() throws Exception {
		...
		tmpstr = String.format("D09BTRD_%s.%s_%s","C02", hVouchCdKind, hPcceCurrCodeGl);  
		comcr.hGsvhModPgm = tmpstr;
		comcr.hGsvhModWs = "BIL_BTRD";
    ...
    public static void main(String[] args) throws Exception {
        BilRD09BTRD proc = new BilRD09BTRD();
