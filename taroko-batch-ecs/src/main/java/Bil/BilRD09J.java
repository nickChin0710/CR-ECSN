...
/*國際信用卡清算明細表-信用卡*/
public class BilRD09J extends AccessDAO {
    private String progname = "列印國際信用卡清算明細表-信用卡JPY程式  112/03/22  V1.00.01";
    CommFunction   comm  = new CommFunction();
    CommCrd        comc  = new CommCrd();
    CommCrdRoutine comcr = null;

    String prgmId = "BilRD09J";
    String prgmName = "列印國際信用卡清算明細表-信用卡JPY程式";
    String rptName = "國際信用卡清算明細表-信用卡JPY";
    String rptId = "BILR_D09_JPY";
    int rptSeq = 0;
    List<Map<String, Object>> lpar1 = new ArrayList<Map<String, Object>>();

    
    String rptNameD02 = "國際信用卡清算彙計表-信用卡JPY";
    String rptIdD02 = "CRD02_JPY";
    int rptSeqD02 = 0;
    ...
    void selectBilCurpost() throws Exception {
    	...
    	sqlCmd =  "select card_no,settl_flag,dc_amount as dest_amt,purchase_date,txn_code,sign_flag ";
		...
		sqlCmd += " order by sign_flag,txn_code ";
    ...
    void printHeader() {
        ...
        buf = comcr.insertStrCenter(buf, "國際信用卡清算明細表-信用卡JPY", 132);
