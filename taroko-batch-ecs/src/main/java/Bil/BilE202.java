...
public class BilE202 extends BilE200 {
    private  final String PROGNAME = "明台住火險保險扣款 112/08/30 V1.00.03";
    ...
    protected int inputFileProcess() throws Exception {
        ...
        sqlCmd += " and file_name like '07192904_3144_C02_%' ";
	...
	int open_file() throws Exception {
		outputFileName = String.format("07192904_3144_C03_%s.txt",hBusinessDate);
	...
	void procFTP(String isFileName) throws Exception {
		...
		commFTP.hEflgSourceFrom = "BilE202"; /* 區分不同類的 FTP 檔案-細分類 (非必要) */
