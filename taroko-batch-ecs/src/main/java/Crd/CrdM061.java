...
*  ---------  --------- ----------- ----------------------------------------  *
*  109/02/04  V1.00.00   Pino       program initial                           *
...
*  112/03/13  V1.00.05   Wilson     調整procFTP執行順序                                                                          *
*  112/04/23  V1.00.06   Wilson     調整產檔路徑                                                                                              *
*  112/05/02  V1.00.07   Wilson     調整track2格式                                                                                    *
*  112/05/22  V1.00.08   Wilson     english2後面加?                                                                                 *
*  112/05/25  V1.00.09   Wilson     稱謂、英文姓名調整                                                                                   *
*  112/12/03  V1.00.10   Wilson     crd_item_unit不判斷卡種                                                              *
******************************************************************************/
...
public class CrdM061 extends AccessDAO {
    private String progname = "產生PP卡新製/補發製卡檔程式    112/12/03  V1.00.10  ";
    ...
    public int mainProcess(String[] args) {
        try {
            ...
            // =====================================
            if (args.length > 2) {
                comc.errExit("Usage : CrdM061  [test] [batch_seq]", "");
            }
...
//            sqlCmd += "and d.card_type = a.card_type ";
    ...
    int openTextFile() throws Exception {
        ...
        hNcccFilename = String.format("pp_%02d_makecard_ns_%8s%02d.txt", tmpVendor, hYyyymmdd, hNn);
    ...
    void checkFileCtl() throws Exception {
    	...
    	String likeFilename = "";
    	String hFileName = "";
    	likeFilename = String.format("pp_%02d_makecard_ns_%8s", tmpVendor, hYyyymmdd)+"%";
...
//        sqlCmd += "and d.card_type = a.card_type ";
    ...
    void createNcccNewFile() throws Exception {
    	...
    	ncccData.vPpCardNo1        = hEmbpPpCardNo;
    	ncccData.filler1        		 = "";
    	...
    	ncccData.vChineseName       = hIdnoChiName;
    	ncccData.filler11      	     = ">>>";
    ...
    class Buf1 {
        ...
        String allText() throws UnsupportedEncodingException {
            String rtn = "";
            rtn += fixLeft(seq, 6);
            rtn += fixLeft(vPpCardNo1, 18);
            rtn += fixLeft(filler1, 2);
