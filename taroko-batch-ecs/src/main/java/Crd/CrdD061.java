...
*  ---------  --------- ----------- ----------------------------------------  *
*  108/12/11  V1.00.00    Pino      program initial                           *
...
*  112/07/04  V1.00.08   Wilson     處理悠遊卡自動加值旗標                                                                           *
*  112/08/26  V1.00.09   Wilson     修正弱掃問題                                                                                             *
*  112/11/27  V1.00.10   Wilson     檔案增加法人統一編號欄位                                                                      *
*  112/12/06  V1.00.11   Wilson     crd_item_unit不判斷卡種                                                             *
******************************************************************************/
...
public class CrdD061 extends AccessDAO {
    private String progname = "產生一般信用卡新製/重製製卡檔程式  112/12/06  V1.00.11 ";
...
// if (DEBUG == 1) showLogMessage("D", "", " CMD=[" + sqlCmd + "] ");
    ...
    int openTextFile() throws Exception {
        ...
        hNcccFilename = String.format("gn_%02d_makecard_ns_%08d%02d.txt", tmpVendor, hYyyymmdd, hNn);
    ...
    void checkFileCtl() throws Exception {
    	...
    	String likeFilename = "";
    	String hFileName = "";
    	likeFilename = String.format("gn_%02d_makecard_ns_%08d", tmpVendor, hYyyymmdd)+"%";
...
/*************************************************************************/
    ...
    /***********************************************************************/
    void selectPtrRcrate(double hAcnoRevolveIntRate) throws Exception {

        sqlCmd = "select rcrate_year ";
        sqlCmd += " from ptr_rcrate ";
        sqlCmd += " where rcrate_day = ? ";
        setDouble(1, hAcnoRevolveIntRate);
        recordCnt = selectTable();
        if (recordCnt > 0) {
