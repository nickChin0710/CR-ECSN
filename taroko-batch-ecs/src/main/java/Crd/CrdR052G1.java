...
public class CrdR052G1 extends AccessDAO {
    private String progname = "產生EPAY綁卡數明細資料檔程式    112/09/06  V1.00.01 ";
    ...
    void openTextFile() throws Exception {
        ...
        filename = String.format("EPAYCARD_%s.TXT", hBusiBusinessDate);
        hFileName = filename;
        rptName1 = filename;
    }    
    ...
    void process() throws Exception {
        ...
        sqlCmd += "        b.id_no, ";
        sqlCmd += "        a.link_date ";
        sqlCmd += "   from epay_card a,crd_idno b ";
        sqlCmd += "  where a.id_p_seqno = b.id_p_seqno ";
        sqlCmd += "    and a.link_date between ? and ? ";
        ...
        while (fetchTable(cursorIndex)) {
        	...
        	hTmpLinkDate = getValue("link_date");
