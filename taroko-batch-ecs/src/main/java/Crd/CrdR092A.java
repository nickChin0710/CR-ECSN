...
public class CrdR092A extends AccessDAO {
    private final String PROGNAME = "國際信用卡鍵檔資料上傳處理回覆明細表(一般卡)  112/12/20 V1.01.01";
    ...
    String prgmId    = "CrdR092A";

    String rptIdR1 = "CRD92A";
    String rptName1  = "國際信用卡鍵檔資料上傳處理回覆明細表(一般卡)";
...
public int mainProcess(String[] args) {
 try {
    ...
    // =====================================
    if(args.length > 3) {
       comc.errExit("Usage : CrdR092A [yyyymmdd] [seq_no] ", "");
      }
...
void headFile() throws Exception {
        ...
        buf = comcr.insertStr(buf, "報表代號: CRD92A     科目代號:"            ,  1);
