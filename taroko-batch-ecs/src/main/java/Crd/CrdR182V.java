...
public class CrdR182V extends AccessDAO {
    private final String PROGNAME = "VISA CARD季報表  112/11/10 V1.00.02";
    ...
    String prgmId    = "CrdR182V";

    String rptIdR1 = "CRM182V";
    String rptName1  = "VISA CARD季報表";
 ...
 try 
   {
    ...
    // =====================================
    if(args.length > 3) {
       comc.errExit("Usage : CrdR182V [yyyymmdd] [seq_no] ", "");
      }
...
/***********************************************************************/
    void selectCrdIdno() throws Exception {
	    ...
	    //至少動用(消費)一次有效戶數(白金卡)
	    allData[1][3] = selectCrdIdnoConsumeP();
	    showLogMessage("I","","Read END selectCrdIdnoConsumeP ="+ allData[1][3]);
	    ...
	    //至少動用(消費)一次有效戶數(御璽卡)
	    allData[1][5] = selectCrdIdnoConsumeS();
	    showLogMessage("I","","Read END selectCrdIdnoConsumeS ="+ allData[1][5]);
	    
	    //至少動用(消費)一次有效戶數(無限卡)
	    allData[1][6] = selectCrdIdnoConsumeI();
	    showLogMessage("I","","Read END selectCrdIdnoConsumeI ="+ allData[1][6]);
    }
...
/***********************************************************************/
	...
	/***********************************************************************/
	int selectCrdIdnoConsumeP() throws Exception {
	...
	int selectCrdIdnoConsumeC2() throws Exception {
		...
		/***********************************************************************/
	int selectCrdIdnoConsumeS() throws Exception {
...
/***********************************************************************/
	...
	/***********************************************************************/
	void selectActDebtPnP() throws Exception {
		int tmpFlowCnt = 0;
		int tmpBegBalPnSum = 0;
	...
	/***********************************************************************/
	void selectActDebtPnS() throws Exception {
		int tmpFlowCnt = 0;
		int tmpBegBalPnSum = 0;
...
/***********************************************************************/
	void selectActDebtLate() throws Exception {
	    ...
	    sqlCmd += "                             and c.bin_type = 'V' ";
	    sqlCmd += "                             and a.end_bal > 0 ";
//	    sqlCmd += "                             and a.acct_code not in ('DB') ";  --先預留是否排除呆帳
	    sqlCmd += "                           group by c.card_note,a.acct_type,b.int_rate_mcode,c.card_no) ";
	    sqlCmd += " group by  card_note2,int_rate_mcode2  ";
	...
	void selectCrdCard() throws Exception {
		...
		//季流通戶數(白金卡)
	    allData[18][3] = selectCrdIdnoCurrP();
	    showLogMessage("I","","Read END selectCrdIdnoCurrP ="+ allData[18][3]);
		...
		//季流通戶數(御璽卡)
	    allData[18][5] = selectCrdIdnoCurrS();
	    showLogMessage("I","","Read END selectCrdIdnoCurrS ="+ allData[18][5]);
	    
		//季流通戶數(無限卡)
	    allData[18][6] = selectCrdIdnoCurrI();
	    showLogMessage("I","","Read END selectCrdIdnoCurrI ="+ allData[18][6]);
		...
		//季新增戶數(白金卡)
	    allData[20][3] = selectCrdIdnoNewP();
	    showLogMessage("I","","Read END selectCrdIdnoNewP ="+ allData[20][3]);
		...
		//季新增戶數(御璽卡)
	    allData[20][5] = selectCrdIdnoNewS();
	    showLogMessage("I","","Read END selectCrdIdnoNewS ="+ allData[20][5]);
	    
		//季新增戶數(無限卡)
	    allData[20][6] = selectCrdIdnoNewI();
	    showLogMessage("I","","Read END selectCrdIdnoNewI ="+ allData[20][6]);
		...
		//季停用戶數(白金卡)
	    allData[22][3] = selectCrdIdnoOppoP();
	    showLogMessage("I","","Read END selectCrdIdnoOppoP ="+ allData[22][3]);
		...
		//季停用戶數(御璽卡)
	    allData[22][5] = selectCrdIdnoOppoS();
	    showLogMessage("I","","Read END selectCrdIdnoOppoS ="+ allData[22][5]);
	    
		//季停用戶數(無限卡)
	    allData[22][6] = selectCrdIdnoOppoI();
	    showLogMessage("I","","Read END selectCrdIdnoOppoI ="+ allData[22][6]);
	...
	/***********************************************************************/
	int selectCrdIdnoCurrP() throws Exception 
	{
	...
	/***********************************************************************/
	int selectCrdIdnoCurrS() throws Exception 
	{
	...
	void selectCrdCardCurr() throws Exception {
	    ...
	    sqlCmd += " where bin_type = 'V' ";
	    sqlCmd += "   and current_code = '0' ";
	    sqlCmd += " group by card_note,acct_type ";
	    int recCnt = selectTable();
	    ...
	    for(int i = 0; i < recCnt; i++ ) {
	  	    ...
	  	    switch (tmpItemType) {
	  	        ...
	  	        case "C": allData[19][1] = tmpCnt;   
	  	        break;
	  	        
	  	        case "G": allData[19][2] = tmpCnt;   
	  	        break;
	  	        
	  	        case "P": allData[19][3] = tmpCnt;   
	  	        break;
	  	        
	  	        case "C2": allData[19][4] = allData[19][4] + tmpCnt;   
	  	        break;
	  	        
	  	        case "S": allData[19][5] = tmpCnt;   
	  	        break;
	  	        
	  	        case "I": allData[19][6] = tmpCnt;   
	  	        break;
	  	    }
	    }
	}
	...
	int selectCrdIdnoNewG() throws Exception {
		...
		/***********************************************************************/
	int selectCrdIdnoNewP() throws Exception {
	...
	int selectCrdIdnoNewC2() throws Exception {
		...
		/***********************************************************************/
	int selectCrdIdnoNewS() throws Exception {
	...
	void selectCrdCardNew() throws Exception {
	    ...
	    for(int i = 0; i < recCnt; i++ ) {
	  	    ...
	  	    switch (tmpItemType) {
	  	        ...
	  	        case "C": allData[21][1] = tmpCnt;   
	  	        break;
	  	        
	  	        case "G": allData[21][2] = tmpCnt;   
	  	        break;
	  	        
	  	        case "P": allData[21][3] = tmpCnt;   
	  	        break;
	  	        
	  	        case "C2": allData[21][4] = allData[21][4] + tmpCnt;  
	  	        break;
	  	        
	  	        case "S": allData[21][5] = tmpCnt;   
	  	        break;
	  	        
	  	        case "I": allData[21][6] = tmpCnt;   
	  	        break;
	  	    }
	    }
	}
...
/****** *****************************************************************/
	...
	/***********************************************************************/
	int selectCrdIdnoOppoP() throws Exception {
	...
	/***********************************************************************/ 
	int selectCrdIdnoOppoS() throws Exception { 
	...
	void selectCrdCardOppo() throws Exception {
	    ...
	    for(int i = 0; i < recCnt; i++ ) {
	  	    ...
	  	    switch (tmpItemType) {
	  	        ...
	  	        case "C": allData[23][1] = tmpCnt;   
	  	        break;
	  	        
	  	        case "G": allData[23][2] = tmpCnt;   
	  	        break;
	  	        
	  	        case "P": allData[23][3] = tmpCnt;   
	  	        break;
	  	        
	  	        case "C2": allData[23][4] = allData[23][4] + tmpCnt;   
	  	        break;
	  	        
	  	        case "S": allData[23][5] = tmpCnt;   
	  	        break;
	  	        
	  	        case "I": allData[23][6] = tmpCnt;   
	  	        break;
	  	    }
	    }
	}
  ...
  class buf1 
    {
        ...
        String allText() throws UnsupportedEncodingException {
            ...
            rtn += fixLeft(data01       ,  14+1);
            rtn += fixLeft(data02       ,  14+1);
            rtn += fixLeft(data03       ,  14+1);
            rtn += fixLeft(data04       ,  14+1);
            rtn += fixLeft(data05       ,  14+1);
            rtn += fixLeft(data06       ,  14+1);
 //         rtn += fixLeft(len          ,  1);
            return rtn;
        }
