...
public class CrdR052G3 extends AccessDAO {
    private String progname = "產生台灣PAY近1年有使用之卡數明細資料檔程式    112/09/06  V1.00.01 ";
    ...
    void openTextFile() throws Exception {
        ...
        filename = String.format("HCECARD_USE_%s.TXT", hBusiBusinessDate);
        hFileName = filename;
        rptName1 = filename;
    }    
    ...
    void process() throws Exception {
    	...
    	sqlCmd += "    and a.v_card_no in (select ecs_v_card_no "; 
    	sqlCmd += "                          from bil_fiscdtl ";
    	sqlCmd += "                         where ecs_acct_code in ('BL','ID','IT','AO','OT') ";
    	sqlCmd += "                           and ecs_v_card_no <> '' ";
