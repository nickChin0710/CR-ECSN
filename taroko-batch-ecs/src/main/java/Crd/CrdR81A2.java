...
*  112/11/08 V1.00.01  Wilson      日期減一天                                                                                                    *
******************************************************************************/
package Crd;
...
public class CrdR81A2 extends AccessDAO {
    private String PROGNAME = "員工使用信用卡情形明細表(各分行)  112/11/08 V1.00.01";
    ...
    private final String DATA_FORM = "RCRM81A2";
    ...
    public int mainProcess(String[] args) {
        try {
            ...
            // =====================================
            if (args.length > 3) {
                comc.errExit("Usage : CrdR81A2 [yyyymmdd] [seq_no] ", "");
            }
            /*
...
//                continue;
    ...
    void writeHead(int idx) throws Exception {
        ...
        buf = "";
        if (idx == 1) {
        	buf = comcr.insertStr(buf, emplUNitNo, 1);
        }
        else {
        	buf = comcr.insertStr(buf, tempUNitNo, 1);
        }
