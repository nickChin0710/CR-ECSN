 ...
 *  ---------------  ------------ ----------- -------------------------------- *
*   2022/08/03     V1.00.01    JeffKung   initial draft                        *
 *                                                                             *
 *******************************************************************************/
...
/*消費回饋聯名機構處理程式*/
public class EcsB080 extends AccessDAO {

    private String PROGNAME = "ECS批次程式排程處理程式-畫面設定Rerun V1.00.01 2022/08/03";
    ...
    public int mainProcess(String[] args) throws Exception {
        ...
        try {
            ...
            if (args.length < 1 ) {
                comcr.errRtn("Usage : EcsB080 shell_id ", "", "");
            }
    ...
    void selectEcsBatchCtl() throws Exception {
        ...
        sqlCmd += "  and     rerun_proc = 'Y' ";   //畫面異動要rerun並且尚未處理過        
