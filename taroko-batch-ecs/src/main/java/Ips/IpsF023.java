...
/*鎖退卡暨關閉自動加值功\能紀錄檔(I2B003)接收處理*/
public class IpsF023 extends AccessDAO {
    private String progname = "鎖退卡暨關閉自動加值功\\能紀錄檔(I2B003)接收處理  109/12/15 V1.00.01";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2 && args.length != 3) {
                comc.errExit("Usage : IpsF023 [[notify_date][fo1yy_flag]] [force_flag][seq(nn)]", "");
            }
    ...
    void fileOpen() throws Exception {
        ...
        while (true) {
            ...
            tmpstr1 = String.format("%s", comc.rtrim(dtl.txnType));
            if (!tmpstr1.equals("4F") && !tmpstr1.equals("51") && !tmpstr1.equals("91")) {
