...
*  112-05-24  V1.00.02    Alex      壓縮檔案並產生OK檔後FTP到指定路徑                                           *
******************************************************************************/
...
/*要求拒絕代行名單檔(B2I004)產生*/
public class IpsF004 extends AccessDAO {
    private String progname = "要求拒絕代行名單檔(B2I004)產生  112/05/24 V1.00.02";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2) {
                comc.errExit("Usage : IpsF004 [notify_date] [force_flag (Y/N)]", "");
            }
            ...
            selectPtrBusinday();
            fileSeq = "01";
            tmpstr1 = String.format("B2I004_%4.4s%8.8s%2.2s.dat", comc.IPS_BANK_ID4, hTnlgNotifyDate, fileSeq);
...
//            moveFile();
    ...
    /***********************************************************************/
    void selectIpsB2i004Log() throws Exception {
    ...
    /***********************************************************************/
    void updateIpsB2i004LogA() throws Exception {
        daoTable = "ips_b2i004_log";
    ...
    void fileOpen() throws Exception {
        ...
        tmpstr1 = String.format("H%6.6s_%32.32s", "B2I004", " ");
