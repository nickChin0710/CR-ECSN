...
*  112/05/18  V1.00.08    Alex      重新報送直接寫入 ips_b2i003_log                *
*  112/10/03  V1.00.09    Wilson    還原原處理方式，重新報送由IpsI006處理                                        *
******************************************************************************/
...
public class IpsF036A extends AccessDAO {
  private final String progname = "銀行聯名卡黑名單清除暨回覆檔(I2B006)處理  112/10/03 V1.00.09";
...
//        comc.errExit("Usage : IpsF036A [[notify_date][fo1yy_flag]] [force_flag][seq(nn)]", "");
//      }
