...
/*每日卡片退費紀錄檔(I2B005)接收處理*/
public class IpsF025 extends AccessDAO {
    private String progname = "每日卡片退費紀錄檔(I2B005)接收處理  109/12/15 V1.00.01";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2 && args.length != 3) {
                comc.errExit("Usage : IpsF025 [[notify_date][fo1yy_flag]] [force_flag][seq(nn)]", "");
            }
