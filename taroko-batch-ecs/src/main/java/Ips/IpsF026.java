...
/*銀行聯名卡黑名單清除暨回覆檔(I2B006)接收處理*/
public class IpsF026 extends AccessDAO {
    private String progname = "銀行聯名卡黑名單清除暨回覆檔(I2B006)接收處理  109/12/15 V1.00.01";
    ...
    public int mainProcess(String[] args) {
        ...
        try {
            ...
            if (args.length != 0 && args.length != 1 && args.length != 2 && args.length != 3) {
                comc.errExit("Usage : IpsF026 [[notify_date][fo1yy_flag]] [force_flag][seq(nn)]", "");
            }
